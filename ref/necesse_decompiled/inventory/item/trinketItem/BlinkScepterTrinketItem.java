...
public class BlinkScepterTrinketItem extends TrinketItem {
   protected GameTexture attackTexture;

   public BlinkScepterTrinketItem() {
      super(Item.Rarity.EPIC, 1200);
   ...
   public ListGameTooltips getPreEnchantmentTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "blinksceptertip"));
      return var4;
   }
   ...
   public InventoryItem onAttack(Level var1, int var2, int var3, PlayerMob var4, int var5, InventoryItem var6, PlayerInventorySlot var7, int var8, int var9, PacketReader var10) {
      int var11 = Math.min(224, (int)var4.getDistance((float)var2, (float)var3));
      Point2D.Float var12 = GameMath.normalize((float)var2 - var4.x, (float)var3 - var4.y);
      PacketBlinkScepter.applyToPlayer(var1, var4, var12.x, var12.y, (float)var11);
      PacketForceOfWind.addCooldownStack(var4, 5.0F, var1.isServer());
      ...
      if (var1.isServer()) {
         ...
         var1.getServer().network.sendToClientsAtExcept(new PacketBlinkScepter(var13.slot, var12.x, var12.y, (float)var11), (ServerClient)var13, var13);
      }
   ...
   public void showAttack(Level var1, int var2, int var3, AttackAnimMob var4, int var5, InventoryItem var6, int var7, PacketReader var8) {
      if (var1.isClient()) {
         Screen.playSound(GameResources.swoosh2, SoundEffect.effect(var4).volume(0.5F));
      }
