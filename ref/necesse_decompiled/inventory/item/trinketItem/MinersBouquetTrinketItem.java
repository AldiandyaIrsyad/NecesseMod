...
public class MinersBouquetTrinketItem extends TrinketItem {
   public MinersBouquetTrinketItem() {
      super(Item.Rarity.RARE, 600);
   }

   public TrinketBuff[] getBuffs(InventoryItem var1) {
      return new TrinketBuff[]{(TrinketBuff)BuffRegistry.getBuff("minersbouquettrinket")};
   }
   ...
   public ListGameTooltips getPreEnchantmentTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "minersbouquetusetip"));
      return var4;
   }

   public InventoryItem onAttack(Level var1, int var2, int var3, PlayerMob var4, int var5, InventoryItem var6, PlayerInventorySlot var7, int var8, int var9, PacketReader var10) {
      InventoryItem var11 = new InventoryItem("calmingminersbouquet", var6.getAmount());
