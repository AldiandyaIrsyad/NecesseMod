...
public class QueenSpiderSpawnItem extends ConsumableItem {
   public QueenSpiderSpawnItem() {
      super(1, true);
   ...
   public String canPlace(Level var1, int var2, int var3, PlayerMob var4, InventoryItem var5, PacketReader var6) {
      if (var1 instanceof IncursionLevel) {
         return "inincursion";
      } else if (!(var1.biome instanceof SnowBiome)) {
         return "notsnow";
      } else {
         return !var1.isCave ? "notcave" : null;
      }
   }
   ...
   public InventoryItem onPlace(Level var1, int var2, int var3, PlayerMob var4, InventoryItem var5, PacketReader var6) {
      if (var1.isServer()) {
         if (var1 instanceof IncursionLevel) {
            GameMessage var7 = ((IncursionLevel)var1).canSummonBoss("queenspider");
            if (var7 != null) {
         ...
         System.out.println("Queen Spider has been summoned at " + var1.getIdentifier() + ".");
         float var12 = (float)GameRandom.globalRandom.nextInt(360);
         float var8 = GameMath.cos(var12);
         float var9 = GameMath.sin(var12);
         float var10 = 960.0F;
         Mob var11 = MobRegistry.getMob("queenspider", var1);
   ...
   public ListGameTooltips getTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "royaleggtip1"));
      var4.add(Localization.translate("itemtooltip", "royaleggtip2"));
      var4.add(Localization.translate("itemtooltip", "royaleggtip3"));
      return var4;
   }
}
