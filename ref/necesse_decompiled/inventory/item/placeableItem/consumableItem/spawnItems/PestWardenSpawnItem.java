...
public class PestWardenSpawnItem extends ConsumableItem {
   public PestWardenSpawnItem() {
      super(1, true);
   ...
   public String canPlace(Level var1, int var2, int var3, PlayerMob var4, InventoryItem var5, PacketReader var6) {
      if (var1 instanceof IncursionLevel) {
         ...
         return var1.getIslandDimension() == -2 && var1.biome instanceof SwampBiome ? null : "notdeepswampcave";
      }
   }
   ...
   public InventoryItem onPlace(Level var1, int var2, int var3, PlayerMob var4, InventoryItem var5, PacketReader var6) {
      if (var1.isServer()) {
         if (var1 instanceof IncursionLevel) {
            GameMessage var7 = ((IncursionLevel)var1).canSummonBoss("pestwarden");
            if (var7 != null) {
         ...
         System.out.println("Pest Warden has been summoned at " + var1.getIdentifier() + ".");
         ...
         float var10 = 960.0F;
         Mob var11 = MobRegistry.getMob("pestwarden", var1);
   ...
   public ListGameTooltips getTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "decayingleaftip1"));
      var4.add(Localization.translate("itemtooltip", "decayingleaftip2"));
      return var4;
   }
}
