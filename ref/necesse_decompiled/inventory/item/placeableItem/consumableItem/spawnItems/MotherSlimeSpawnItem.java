...
public class MotherSlimeSpawnItem extends ConsumableItem {
   ...
   public InventoryItem onPlace(Level var1, int var2, int var3, PlayerMob var4, InventoryItem var5, PacketReader var6) {
      if (var1.isServer()) {
         if (var1 instanceof IncursionLevel) {
            GameMessage var7 = ((IncursionLevel)var1).canSummonBoss("motherslime");
            if (var7 != null) {
         ...
         System.out.println("Mother Slime has been summoned at " + var1.getIdentifier() + ".");
         float var12 = (float)GameRandom.globalRandom.nextInt(360);
         float var8 = GameMath.cos(var12);
         float var9 = GameMath.sin(var12);
         float var10 = 960.0F;
         Mob var11 = MobRegistry.getMob("motherslime", var1);
   ...
   public ListGameTooltips getTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "slimeeggstip"));
      var4.add(Localization.translate("itemtooltip", "motherslimesummontip"));
      return var4;
   }
}
