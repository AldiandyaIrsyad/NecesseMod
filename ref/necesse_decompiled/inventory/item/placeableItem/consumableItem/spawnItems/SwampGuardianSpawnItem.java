...
public class SwampGuardianSpawnItem extends ConsumableItem {
   public SwampGuardianSpawnItem() {
      super(1, true);
   ...
   public String canPlace(Level var1, int var2, int var3, PlayerMob var4, InventoryItem var5, PacketReader var6) {
      if (var1 instanceof IncursionLevel) {
         return "inincursion";
      } else if (!(var1.biome instanceof SwampBiome)) {
         return "notswamp";
      } else {
   ...
   public InventoryItem onPlace(Level var1, int var2, int var3, PlayerMob var4, InventoryItem var5, PacketReader var6) {
      if (var1.isServer()) {
         if (var1 instanceof IncursionLevel) {
            GameMessage var7 = ((IncursionLevel)var1).canSummonBoss("swampguardian");
            if (var7 != null) {
         ...
         System.out.println("Swamp Guardian has been summoned at " + var1.getIdentifier() + ".");
         ...
         float var10 = 960.0F;
         Mob var11 = MobRegistry.getMob("swampguardian", var1);
   ...
   public ListGameTooltips getTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "spikedfossiltip1"));
      var4.add(Localization.translate("itemtooltip", "spikedfossiltip2"));
      return var4;
   }
}
