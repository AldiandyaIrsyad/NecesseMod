...
public class ReaperSpawnItem extends ConsumableItem {
   ...
   public String canPlace(Level var1, int var2, int var3, PlayerMob var4, InventoryItem var5, PacketReader var6) {
      if (var1 instanceof IncursionLevel) {
         ...
         return var1.getIslandDimension() != -2 ? "notdeepcave" : null;
      }
   }
   ...
   public ListGameTooltips getTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "shadowgatetip1"));
      var4.add(Localization.translate("itemtooltip", "reapersummontip"));
      return var4;
   }
}
