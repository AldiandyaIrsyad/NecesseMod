...
public class HomestoneObjectItem extends ObjectItem {
   public HomestoneObjectItem(GameObject var1) {
      super(var1);
   }
   ...
   public static InventoryItem setupHomestoneItem(InventoryItem var0, Level var1) {
      return setupHomestoneItem(var0, var1.getIslandX(), var1.getIslandY());
   }

   public static InventoryItem setupHomestoneItem(InventoryItem var0, int var1, int var2) {
      GNDItemMap var3 = var0.getGndData();
      setupHomestoneGNDData(var3, var1, var2);
      return var0;
   }

   public static GNDItemMap homestoneGNDData(int var0, int var1) {
      GNDItemMap var2 = new GNDItemMap();
      setupHomestoneGNDData(var2, var0, var1);
      return var2;
   }

   public static void setupHomestoneGNDData(GNDItemMap var0, int var1, int var2) {
