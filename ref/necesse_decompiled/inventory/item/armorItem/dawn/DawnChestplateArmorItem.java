...
public class DawnChestplateArmorItem extends ChestArmorItem {
   ...
   public DawnChestplateArmorItem() {
      super(29, 1400, Item.Rarity.EPIC, "dawnchestplate", "dawnarms");
   }

   public ArmorModifiers getArmorModifiers(InventoryItem var1, Mob var2) {
      return new ArmorModifiers(new ModifierValue[]{new ModifierValue(BuffModifiers.RESILIENCE_GAIN, 0.25F), new ModifierValue(BuffModifiers.ATTACK_SPEED, 0.1F)});
   }
