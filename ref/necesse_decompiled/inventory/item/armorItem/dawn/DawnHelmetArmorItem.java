...
public class DawnHelmetArmorItem extends SetHelmetArmorItem {
   public GameTexture brokenTexture;

   public DawnHelmetArmorItem() {
      super(23, (DamageType)null, 1400, Item.Rarity.EPIC, "dawnhelmet", "dawnchestplate", "dawnboots", "dawnsetbonus");
   }

   public ArmorModifiers getArmorModifiers(InventoryItem var1, Mob var2) {
      return new ArmorModifiers(new ModifierValue[]{new ModifierValue(BuffModifiers.MAX_RESILIENCE_FLAT, 40), new ModifierValue(BuffModifiers.MELEE_DAMAGE, 0.2F), new ModifierValue(BuffModifiers.RANGED_DAMAGE, 0.2F)});
   }
