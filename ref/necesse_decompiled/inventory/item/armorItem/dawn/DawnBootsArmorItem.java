...
public class DawnBootsArmorItem extends BootsArmorItem {
   ...
   public DawnBootsArmorItem() {
      super(17, 1400, Item.Rarity.EPIC, "dawnboots");
   }

   public ArmorModifiers getArmorModifiers(InventoryItem var1, Mob var2) {
      return new ArmorModifiers(new ModifierValue[]{new ModifierValue(BuffModifiers.DASH_COOLDOWN, -0.15F), new ModifierValue(BuffModifiers.PROJECTILE_VELOCITY, 0.15F), new ModifierValue(BuffModifiers.SPEED, this.speed.getValue(this.getUpgradeTier(var1)))});
   }
