...
public class SpideriteCrownArmorItem extends SetHelmetArmorItem {
   public GameTexture lightTexture;

   public SpideriteCrownArmorItem() {
      super(16, DamageTypeRegistry.SUMMON, 1400, Item.Rarity.EPIC, "spideritecrown", "spideritechestplate", "spideritegreaves", "spideritecrownsetbonus");
      this.hairDrawOptions = ArmorItem.HairDrawMode.OVER_HAIR;
      this.headArmorBackTextureName = "spideritecrownback";
   }

   public ArmorModifiers getArmorModifiers(InventoryItem var1, Mob var2) {
      return new ArmorModifiers(new ModifierValue[]{new ModifierValue(BuffModifiers.SUMMON_DAMAGE, 0.15F), new ModifierValue(BuffModifiers.SUMMONS_SPEED, 0.3F), new ModifierValue(BuffModifiers.MAX_SUMMONS, 1)});
   }
