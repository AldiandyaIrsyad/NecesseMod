...
public class SpideriteHelmetArmorItem extends SetHelmetArmorItem {
   public GameTexture lightTexture;

   public SpideriteHelmetArmorItem() {
      super(28, DamageTypeRegistry.MELEE, 1400, Item.Rarity.EPIC, "spideritehelmet", "spideritechestplate", "spideritegreaves", "spideritehelmetsetbonus");
   }

   public ArmorModifiers getArmorModifiers(InventoryItem var1, Mob var2) {
      return new ArmorModifiers(new ModifierValue[]{new ModifierValue(BuffModifiers.MELEE_ATTACK_SPEED, 0.15F), new ModifierValue(BuffModifiers.DASH_COOLDOWN, -0.3F)});
   }
