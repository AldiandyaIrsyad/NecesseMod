...
public class SpideriteHatArmorItem extends SetHelmetArmorItem {
   public GameTexture lightTexture;

   public SpideriteHatArmorItem() {
      super(21, DamageTypeRegistry.MAGIC, 1400, Item.Rarity.EPIC, "spideritehat", "spideritechestplate", "spideritegreaves", "spideritehatsetbonus");
   }

   public ArmorModifiers getArmorModifiers(InventoryItem var1, Mob var2) {
      return new ArmorModifiers(new ModifierValue[]{new ModifierValue(BuffModifiers.MAGIC_ATTACK_SPEED, 0.15F), new ModifierValue(BuffModifiers.MANA_USAGE, -0.15F)});
   }
