...
public class ShoesArmorItem extends BootsArmorItem {
   public ShoesArmorItem(int var1) {
      super(var1, 0, (String)null);
   }
   ...
   public InventoryItem getDefaultItem(PlayerMob var1, int var2) {
      return addColorData(super.getDefaultItem(var1, var2), var1 == null ? new Color(255, 255, 255) : var1.look.getShoesColor());
   }
