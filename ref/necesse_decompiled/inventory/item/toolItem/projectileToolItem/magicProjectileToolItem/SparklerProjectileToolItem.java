...
public class SparklerProjectileToolItem extends MagicProjectileToolItem {
   public SparklerProjectileToolItem() {
      super(600);
      this.rarity = Item.Rarity.COMMON;
      this.attackAnimTime.setBaseValue(200);
      this.attackDamage.setBaseValue(10.0F).setUpgradedValue(1.0F, 50.0F);
      this.velocity.setBaseValue(100);
      this.attackXOffset = 14;
      this.attackYOffset = 4;
      this.attackRange.setBaseValue(250);
      this.manaCost.setBaseValue(0.5F).setUpgradedValue(1.0F, 3.0F);
   ...
   public ListGameTooltips getPreEnchantmentTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "sparklertip1"));
      var4.add(Localization.translate("itemtooltip", "sparklertip2"));
      return var4;
   }
   ...
   public InventoryItem onAttack(Level var1, int var2, int var3, PlayerMob var4, int var5, InventoryItem var6, PlayerInventorySlot var7, int var8, int var9, PacketReader var10) {
      SparklerProjectile var11 = new SparklerProjectile(var1, var4.x, var4.y, (float)var2, (float)var3, this.getAttackRange(var6), this.getAttackDamage(var6), var4);
   ...
   public InventoryItem onSettlerAttack(Level var1, HumanMob var2, Mob var3, int var4, int var5, InventoryItem var6) {
      ...
      SparklerProjectile var9 = new SparklerProjectile(var1, var2.x, var2.y, var8.x, var8.y, var7, this.getAttackDamage(var6), var2);
