...
public class ReaperScytheProjectileToolItem extends MeleeProjectileToolItem {
   public ReaperScytheProjectileToolItem() {
      super(1200);
      this.rarity = Item.Rarity.EPIC;
      this.attackAnimTime.setBaseValue(350);
      this.attackDamage.setBaseValue(48.0F).setUpgradedValue(1.0F, 60.0F);
   ...
   public ListGameTooltips getPreEnchantmentTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "reaperscythetip"));
      return var4;
   }
   ...
   public InventoryItem onAttack(Level var1, int var2, int var3, PlayerMob var4, int var5, InventoryItem var6, PlayerInventorySlot var7, int var8, int var9, PacketReader var10) {
      ReaperScythePlayerProjectile var11 = new ReaperScythePlayerProjectile(var1, var4, var4.x, var4.y, (float)var2, (float)var3, (float)this.getProjectileVelocity(var6, var4), this.getAttackRange(var6), this.getAttackDamage(var6), this.getKnockback(var6, var4));
   ...
   public InventoryItem onSettlerAttack(Level var1, HumanMob var2, Mob var3, int var4, int var5, InventoryItem var6) {
      ...
      ReaperScythePlayerProjectile var9 = new ReaperScythePlayerProjectile(var1, var2, var2.x, var2.y, var8.x, var8.y, (float)var7, this.getAttackRange(var6), this.getAttackDamage(var6), this.getKnockback(var6, var2));
