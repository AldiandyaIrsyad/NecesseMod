...
public class IronBombToolItem extends ThrowToolItem {
   ...
   public InventoryItem onAttack(Level var1, int var2, int var3, PlayerMob var4, int var5, InventoryItem var6, PlayerInventorySlot var7, int var8, int var9, PacketReader var10) {
      ...
      IronBombProjectile var14 = new IronBombProjectile(var4.x, var4.y, (float)var12.x, (float)var12.y, this.getThrowingVelocity(var6, var4), var13, this.getAttackDamage(var6), var4);
