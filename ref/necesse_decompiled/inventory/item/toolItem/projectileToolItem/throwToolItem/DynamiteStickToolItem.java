...
public class DynamiteStickToolItem extends ThrowToolItem {
   public DynamiteStickToolItem() {
      this.stackSize = 100;
   ...
   public ListGameTooltips getPreEnchantmentTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "destructivetip"));
      return var4;
   }
   ...
   public InventoryItem onAttack(Level var1, int var2, int var3, PlayerMob var4, int var5, InventoryItem var6, PlayerInventorySlot var7, int var8, int var9, PacketReader var10) {
      ...
      DynamiteStickProjectile var14 = new DynamiteStickProjectile(var4.x, var4.y, (float)var12.x, (float)var12.y, this.getThrowingVelocity(var6, var4), var13, this.getAttackDamage(var6), var4);
