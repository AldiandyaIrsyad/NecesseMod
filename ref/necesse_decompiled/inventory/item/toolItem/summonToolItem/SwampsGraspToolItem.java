...
public class SwampsGraspToolItem extends SummonToolItem {
   public SwampsGraspToolItem() {
      super("playerpouncingslime", FollowPosition.WALK_CLOSE, 0.5F, 1200);
   ...
   public void runSummon(Level var1, int var2, int var3, ServerClient var4, int var5, InventoryItem var6, PlayerInventorySlot var7, int var8, int var9, PacketReader var10) {
      int var11 = (int)(1.0F / this.summonSpaceTaken);

      for(int var12 = 0; var12 < var11; ++var12) {
         AttackingFollowingMob var13 = (AttackingFollowingMob)MobRegistry.getMob(this.mobStringID, var1);
         this.summonMob(var4, var13, var2, var3, var5, var6);
      }
   ...
   public ListGameTooltips getPreEnchantmentTooltips(InventoryItem var1, PlayerMob var2, GameBlackboard var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "swampsgrasptip"));
      return var4;
   }
}
