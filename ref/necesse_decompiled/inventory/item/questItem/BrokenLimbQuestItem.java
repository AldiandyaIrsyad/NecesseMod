...
public class BrokenLimbQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public BrokenLimbQuestItem() {
      super(new LocalMessage("itemtooltip", "brokenlimbobtain"));
   }
   ...
   static {
      droppedByMobs.add("skeleton");
      droppedByMobs.add("skeletonthrower");
      droppedByMobs.add("skeletonminer");
   }
}
