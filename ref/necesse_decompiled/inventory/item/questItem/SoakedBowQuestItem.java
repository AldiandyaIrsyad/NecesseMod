...
public class SoakedBowQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public SoakedBowQuestItem() {
      super(new LocalMessage("itemtooltip", "soakedbowobtain"));
   }
   ...
   static {
      droppedByMobs.add("swampdweller");
   }
}
