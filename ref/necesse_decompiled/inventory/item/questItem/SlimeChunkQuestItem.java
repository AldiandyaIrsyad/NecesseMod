...
public class SlimeChunkQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public SlimeChunkQuestItem() {
      super(new LocalMessage("itemtooltip", "slimechunkobtain"));
   }
