...
public class SlimyLauncherQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public SlimyLauncherQuestItem() {
      super(new LocalMessage("itemtooltip", "slimylauncherobtain"));
   }
   ...
   static {
      droppedByMobs.add("swampshooter");
   }
}
