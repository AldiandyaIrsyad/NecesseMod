...
public class ApprenticeScrollQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public ApprenticeScrollQuestItem() {
      super(new LocalMessage("itemtooltip", "apprenticescrollobtain"));
   }
   ...
   static {
      droppedByMobs.add("voidapprentice");
   }
}
