...
public class SpiderLegQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public SpiderLegQuestItem() {
      super(new LocalMessage("itemtooltip", "spiderlegobtain"));
   }
   ...
   static {
      droppedByMobs.add("blackcavespider");
   }
}
