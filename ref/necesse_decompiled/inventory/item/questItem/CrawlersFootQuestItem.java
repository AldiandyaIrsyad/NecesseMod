...
public class CrawlersFootQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public CrawlersFootQuestItem() {
      super(new LocalMessage("itemtooltip", "crawlersfootobtain"));
   }
   ...
   static {
      droppedByMobs.add("desertcrawler");
   }
}
