...
public class WormToothQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public WormToothQuestItem() {
      super(new LocalMessage("itemtooltip", "wormtoothobtain"));
   }
