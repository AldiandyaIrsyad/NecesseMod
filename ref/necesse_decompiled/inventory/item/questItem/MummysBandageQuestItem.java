...
public class MummysBandageQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public MummysBandageQuestItem() {
      super(new LocalMessage("itemtooltip", "mummysbandageobtain"));
   }
