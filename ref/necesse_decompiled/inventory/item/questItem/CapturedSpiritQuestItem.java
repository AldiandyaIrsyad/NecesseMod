...
public class CapturedSpiritQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public CapturedSpiritQuestItem() {
      super(new LocalMessage("itemtooltip", "capturedspiritobtain"));
   }
