...
public class FeralTailQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public FeralTailQuestItem() {
      super(new LocalMessage("itemtooltip", "feraltailobtain"));
   }
