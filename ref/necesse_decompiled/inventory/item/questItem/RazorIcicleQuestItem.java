...
public class RazorIcicleQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public RazorIcicleQuestItem() {
      super(new LocalMessage("itemtooltip", "razoricicleobtain"));
   }
