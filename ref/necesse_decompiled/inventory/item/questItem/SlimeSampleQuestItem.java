...
public class SlimeSampleQuestItem extends QuestItem {
   public static final ArrayList<String> droppedByMobs = new ArrayList();

   public SlimeSampleQuestItem() {
      super(new LocalMessage("itemtooltip", "slimesampleobtain"));
   }
   ...
   static {
      droppedByMobs.add("giantswampslime");
   }
}
