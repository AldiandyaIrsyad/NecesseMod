...
public class SettlementWorkstationEvent extends ContainerEvent {
   public final int tileX;
   public final int tileY;
   public final ArrayList<SettlementWorkstationRecipe> recipes;

   public SettlementWorkstationEvent(SettlementWorkstation var1) {
      this.tileX = var1.tileX;
      this.tileY = var1.tileY;
      this.recipes = new ArrayList(var1.recipes);
   }

   public SettlementWorkstationEvent(PacketReader var1) {
      super(var1);
