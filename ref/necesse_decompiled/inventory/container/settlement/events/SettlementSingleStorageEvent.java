...
public class SettlementSingleStorageEvent extends ContainerEvent {
   public final int tileX;
   public final int tileY;
   public final boolean exists;

   public SettlementSingleStorageEvent(SettlementLevelData var1, int var2, int var3) {
      this.tileX = var2;
      this.tileY = var3;
      this.exists = var1.getStorage(var2, var3) != null;
   }

   public SettlementSingleStorageEvent(PacketReader var1) {
      super(var1);
