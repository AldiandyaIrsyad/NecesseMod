...
public class CommandSettlersClearOrdersAction extends CommandSettlersCustomAction {
   public CommandSettlersClearOrdersAction(SettlementContainer var1) {
      super(var1);
   }
