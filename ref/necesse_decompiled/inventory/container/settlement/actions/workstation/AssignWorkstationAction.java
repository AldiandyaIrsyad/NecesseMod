...
public class AssignWorkstationAction extends ContainerCustomAction {
   public final SettlementContainer container;

   public AssignWorkstationAction(SettlementContainer var1) {
      this.container = var1;
   }
   ...
   public void executePacket(PacketReader var1) {
      ...
      if (this.container.client.isServer()) {
         ...
         if (var4 != null) {
            ...
            var4.assignWorkstation(var2, var3);
         }
      }
