...
public class RemoveWorkstationAction extends ContainerCustomAction {
   public final SettlementDependantContainer container;

   public RemoveWorkstationAction(SettlementDependantContainer var1) {
      this.container = var1;
   }
   ...
   public void executePacket(PacketReader var1) {
      ...
      if (this.container.client.isServer()) {
         ...
         if (var4 != null) {
            ...
            var4.removeWorkstation(var2, var3);
         }
      }
