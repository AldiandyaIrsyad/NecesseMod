...
public class PvPJoinRequestUpdateEvent extends ContainerEvent {
   public long auth;
   public boolean added;
   public String name;

   public PvPJoinRequestUpdateEvent(long var1, boolean var3, String var4) {
      this.auth = var1;
      this.added = var3;
      this.name = var4;
   }

   public PvPJoinRequestUpdateEvent(PacketReader var1) {
      super(var1);
