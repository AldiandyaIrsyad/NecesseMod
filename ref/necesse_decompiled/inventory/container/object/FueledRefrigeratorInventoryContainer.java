...
public class FueledRefrigeratorInventoryContainer extends OEInventoryContainer {
   public final FueledRefrigeratorObjectEntity refrigeratorObjectEntity;
   public int FUEL_START = -1;
   public int FUEL_END = -1;

   public FueledRefrigeratorInventoryContainer(NetworkClient var1, int var2, FueledRefrigeratorObjectEntity var3, PacketReader var4) {
      super(var1, var2, var3, var4);
      this.refrigeratorObjectEntity = var3;
   ...
   public InventoryRange getOEInventoryRange() {
      ...
      return new InventoryRange(var1, ((FueledRefrigeratorObjectEntity)this.objectEntity).fuelSlots, var1.getSize() - 1);
   }
}
