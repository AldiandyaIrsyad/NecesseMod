...
public class DelayLogicGateContainer extends Container {
   public DelayLogicGateEntity entity;
   ...
   public DelayLogicGateContainer(final NetworkClient var1, int var2, final DelayLogicGateEntity var3) {
      super(var1, var2);
      this.entity = var3;
