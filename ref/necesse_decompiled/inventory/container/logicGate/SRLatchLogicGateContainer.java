...
public class SRLatchLogicGateContainer extends Container {
   public SRLatchLogicGateEntity entity;
   public final WireSelectCustomAction setActivateInputs;
   public final WireSelectCustomAction setResetInputs;
   public final WireSelectCustomAction setOutputs;

   public SRLatchLogicGateContainer(final NetworkClient var1, int var2, final SRLatchLogicGateEntity var3) {
      super(var1, var2);
      this.entity = var3;
      this.setActivateInputs = (WireSelectCustomAction)this.registerAction(new WireSelectCustomAction() {
         protected void run(boolean[] var1x) {
            var3.activateInputs = var1x;
            if (var1.isServer()) {
