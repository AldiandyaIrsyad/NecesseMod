...
public class SimpleLogicGateContainer extends Container {
   ...
   public SimpleLogicGateContainer(final NetworkClient var1, int var2, final SimpleLogicGateEntity var3) {
      super(var1, var2);
      this.entity = var3;
