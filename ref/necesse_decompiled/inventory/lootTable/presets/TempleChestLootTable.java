...
public class TempleChestLootTable extends LootTable {
   ...
   public static final OneOfLootItems bars = new OneOfLootItems(LootItem.offset("goldbar", 5, 2), new LootItemInterface[]{LootItem.offset("tungstenbar", 6, 2), LootItem.offset("ancientfossilbar", 6, 2)});
   public static final LootTable extraItems = new LootTable(new LootItemInterface[]{ChanceLootItem.offset(0.5F, "torch", 15, 5), new OneOfTicketLootItems(new Object[]{3, LootItem.between("ironbomb", 2, 5), 1, LootItem.between("dynamitestick", 1, 3)})});
