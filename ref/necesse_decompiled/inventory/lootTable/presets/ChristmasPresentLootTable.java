...
public class ChristmasPresentLootTable extends LootTable {
   ...
   public static final OneOfTicketLootItems oneOfChristmasItems = new OneOfTicketLootItems(new Object[]{100, LootItem.between("snowball", 8, 16), 80, LootItem.between("candycane", 1, 2), 80, LootItem.between("cookies", 2, 4), 50, new LootItem("christmaswreath"), 40, new LootItem("snowmantrainingdummy"), 25, new LootItem("christmastree"), 25, new LootItem("theeldersjinglejamvinyl"), 15, new LootItem("snowlauncher")});
