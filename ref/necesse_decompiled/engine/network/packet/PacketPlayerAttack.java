...
public class PacketPlayerAttack extends Packet {
   ...
   public PacketPlayerAttack(byte[] var1) {
      super(var1);
   ...
   public PacketPlayerAttack(PlayerMob var1, PlayerInventorySlot var2, Item var3, int var4, int var5, int var6, int var7, Packet var8) {
      this.playerX = var1.x;
      this.playerY = var1.y;
   ...
   public void processServer(NetworkPacket var1, Server var2, ServerClient var3) {
      if (var3.checkHasRequestedSelf() && !var3.isDead()) {
         var3.checkSpawned();
         double var4 = var3.playerMob.allowServerMovement(var2, var3, this.playerX, this.playerY);
         if (var4 <= 0.0) {
            var3.playerMob.setPos(this.playerX, this.playerY, false);
         } else {
            GameLog.warn.println(var3.getName() + " attempted to attack from wrong position, snapping back " + var4);
            var2.network.sendToClientsAt(new PacketPlayerMovement(var3, false), (ServerClient)var3);
         }

         var3.playerMob.runAttack(this);
