...
public class PacketActiveSetBuffAbilityUpdate extends Packet {
   public final int slot;
   public final int uniqueID;
   public final Packet content;

   public PacketActiveSetBuffAbilityUpdate(byte[] var1) {
      super(var1);
   ...
   public PacketActiveSetBuffAbilityUpdate(int var1, int var2, Packet var3) {
      this.slot = var1;
      this.uniqueID = var2;
      this.content = var3;
   ...
   public void processClient(NetworkPacket var1, Client var2) {
      if (var2.getLevel() != null) {
         ...
         if (var3 != null && var3.playerMob.getLevel() != null) {
            if (!var3.playerMob.runActiveSetBuffAbilityUpdate(this.uniqueID, this.content)) {
               var2.network.sendPacket(new PacketRequestActiveSetBuffAbility(this.slot));
            }
         } else {
   ...
   public void processServer(NetworkPacket var1, Server var2, ServerClient var3) {
      if (var3.slot == this.slot) {
         ...
         if (var3.playerMob.runActiveSetBuffAbilityUpdate(this.uniqueID, this.content)) {
            var2.network.sendToClientsAtExcept(new PacketActiveSetBuffAbilityUpdate(this.slot, this.uniqueID, this.content), (ServerClient)var3, var3);
         } else {
            var3.playerMob.sendActiveSetBuffAbilityState(var2, var3);
         }
      } else {
