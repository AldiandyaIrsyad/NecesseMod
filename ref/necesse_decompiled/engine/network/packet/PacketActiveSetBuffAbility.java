...
public class PacketActiveSetBuffAbility extends Packet {
   public final int slot;
   public final int buffID;
   public final int uniqueID;
   public final Packet content;

   public PacketActiveSetBuffAbility(byte[] var1) {
      super(var1);
   ...
   public PacketActiveSetBuffAbility(int var1, Buff var2, int var3, Packet var4) {
      this.slot = var1;
   ...
   public void processClient(NetworkPacket var1, Client var2) {
      if (var2.getLevel() != null) {
         ...
         if (var3 != null && var3.playerMob.getLevel() != null) {
            var3.playerMob.runActiveSetBuffAbility(this.buffID, this.uniqueID, this.content);
         } else {
      ...
      if (var3.slot == this.slot) {
         ...
         if (var4 != null && var4.buff instanceof ActiveBuffAbility) {
            ...
            if (var5.canRunAbility(var3.playerMob, var4, this.content)) {
               var3.playerMob.runActiveSetBuffAbility(this.buffID, this.uniqueID, this.content);
               var2.network.sendToClientsAtExcept(new PacketActiveSetBuffAbility(this.slot, var4.buff, this.uniqueID, this.content), (ServerClient)var3, var3);
            }
         }
      } else {
         GameLog.warn.println(var3.getName() + " tried to run active set buff ability from wrong slot, kicking him for desync");
