...
public class PacketMobMana extends Packet {
   public final int mobUniqueID;
   public final boolean isFull;
   private final PacketReader reader;

   public PacketMobMana(byte[] var1) {
      super(var1);
   ...
   public PacketMobMana(Mob var1, boolean var2) {
      ...
      var1.setupManaPacket(var3, var2);
   }
   ...
   public void processClient(NetworkPacket var1, Client var2) {
      if (var2.getLevel() != null) {
         ...
         if (var3 == null) {
            ...
            var3.applyManaPacket(new PacketReader(this.reader), this.isFull);
         }
