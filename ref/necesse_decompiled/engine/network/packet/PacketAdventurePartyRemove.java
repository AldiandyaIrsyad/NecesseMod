...
public class PacketAdventurePartyRemove extends Packet {
   public final int mobUniqueID;
   public final int mobsHash;

   public PacketAdventurePartyRemove(byte[] var1) {
      super(var1);
   ...
   public PacketAdventurePartyRemove(AdventureParty var1, int var2) {
   ...
   public void processClient(NetworkPacket var1, Client var2) {
      var2.adventureParty.clientRemove(this.mobUniqueID);
