...
public class GenerateIslandStructuresEvent extends PreventableGameEvent {
   public final Level level;
   public final float islandSize;
   public final IslandGeneration islandGeneration;

   public GenerateIslandStructuresEvent(Level var1, float var2, IslandGeneration var3) {
      this.level = var1;
