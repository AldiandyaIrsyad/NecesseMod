...
public class PermissionLevelParameterHandler extends ParameterHandler<PermissionLevel> {
   ...
   public PermissionLevelParameterHandler(PermissionLevel var1) {
      this.defaultValue = var1;
   }

   public List<AutoComplete> autocomplete(Client var1, Server var2, ServerClient var3, CmdArgument var4) {
      return autocompleteFromArray(PermissionLevel.values(), (Function)null, (var0) -> {
         return var0.name().toLowerCase();
      }, var4);
   }

   public PermissionLevel parse(Client var1, Server var2, ServerClient var3, String var4, CmdParameter var5) throws IllegalArgumentException {
      PermissionLevel[] var6 = PermissionLevel.values();
      PermissionLevel[] var7 = var6;
      int var8 = var6.length;

      for(int var9 = 0; var9 < var8; ++var9) {
         PermissionLevel var10 = var7[var9];
         if (var4.equalsIgnoreCase(var10.toString())) {
            return var10;
         }
      }

      throw new IllegalArgumentException("Could not find permission level \"" + var4 + "\" for <" + var5.name + ">");
   }
   ...
   public PermissionLevel getDefault(Client var1, Server var2, ServerClient var3, CmdParameter var4) {
