...
public class GNDFloatParameterHandler extends GNDItemParameterHandler<GNDItemFloat> {
   ...
   protected GNDItemFloat parseSecondArg(String var1, CmdParameter var2) {
      try {
         return new GNDItemFloat(Float.parseFloat(var1));
      } catch (NumberFormatException var4) {
         throw new IllegalArgumentException(var1 + " for <" + var2.name + "> is not a float");
      }
   }

   public GNDItemFloat getDefault(Client var1, Server var2, ServerClient var3, CmdParameter var4) {
      return null;
   }
