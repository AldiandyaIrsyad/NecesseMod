...
public class GNDLongParameterHandler extends GNDItemParameterHandler<GNDItemLong> {
   ...
   protected GNDItemLong parseSecondArg(String var1, CmdParameter var2) {
      try {
         return new GNDItemLong(Long.parseLong(var1));
      } catch (NumberFormatException var4) {
         throw new IllegalArgumentException(var1 + " for <" + var2.name + "> is not a long");
      }
   }

   public GNDItemLong getDefault(Client var1, Server var2, ServerClient var3, CmdParameter var4) {
      return null;
   }
