...
public class HelpServerCommand extends ModularChatCommand {
   ...
   public void runModular(Client var1, Server var2, ServerClient var3, Object[] var4, String[] var5, CommandLog var6) {
      ...
      if (var9 != null) {
         ...
         var6.add(GameColor.CYAN.getColorCode() + "Commands page " + var8 + " of " + var12 + " (" + CommandsManager.getPermissionLevel(var1, var3).name.translate() + "):");

         for(int var15 = var13; var15 < var14; ++var15) {
            ChatCommand var16 = (ChatCommand)var10.get(var15);
            var6.add(var16.getFullHelp(var3 != null));
         }
      }
