...
public class CaveSpiderWebEvent extends GroundEffectEvent {
   ...
   public CaveSpiderWebEvent(Mob var1, int var2, int var3, GameRandom var4) {
   ...
   public void init() {
      ...
      this.tickCounter = 0;
      if (this.isClient()) {
         this.level.entityManager.addParticle((Particle)(new CaveSpiderWebParticle(this.level, (float)this.x, (float)this.y, 5000L)), Particle.GType.CRITICAL);
      }
