...
public class TempleExitObjectEntity extends PortalObjectEntity {
   public TempleExitObjectEntity(Level var1, int var2, int var3, int var4, int var5) {
      super(var1, "templeexit", var2, var3, var1.getIdentifier(), var4, var5);
