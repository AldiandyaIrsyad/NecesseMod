...
public class SalvageStationObjectEntity extends ObjectEntity implements OEInventory {
   public Inventory inventory = new Inventory(5);

   public SalvageStationObjectEntity(Level var1, int var2, int var3) {
      super(var1, "salvagestation", var2, var3);
      this.inventory.filter = (var0, var1x) -> {
         if (var1x == null) {
            return true;
         } else {
            return var1x.item instanceof SalvageableItem && ((SalvageableItem)var1x.item).getCanBeSalvagedError(var1x) == null;
         }
      };
   }
