...
public abstract class FueledProcessingTechInventoryObjectEntity extends FueledProcessingInventoryObjectEntity {
   public Tech[] techs;
   ...
   public FueledProcessingTechInventoryObjectEntity(Level var1, String var2, int var3, int var4, int var5, int var6, int var7, boolean var8, boolean var9, boolean var10, Tech... var11) {
   ...
   public FutureCrafts getExpectedResults() {
      if (this.expectedResultItems == null) {
         ...
         for(int var2 = 0; var2 < 1000; ++var2) {
            ...
            for(int var4 = this.fuelSlots + this.inputSlots - 1; var4 >= this.fuelSlots; --var4) {
               InventoryRange var5 = new InventoryRange(var1, var4, this.fuelSlots + this.inputSlots - 1);
   ...
   public FutureCrafts getCurrentAndExpectedResults() {
      ...
      for(int var2 = this.fuelSlots + this.inputSlots; var2 < this.inventory.getSize(); ++var2) {
   ...
   public FueledProcessingInventoryObjectEntity.NextProcessTask getNextProcessTask() {
      InventoryRange var1 = new InventoryRange(this.inventory, this.fuelSlots, this.fuelSlots + this.inputSlots - 1);
      Recipe var2 = (Recipe)Recipes.streamRecipes(this.techs).filter((var2x) -> {
         return var2x.canCraftRange(this.getLevel(), (PlayerMob)null, (InventoryRange)var1, false).canCraft();
      }).findFirst().orElse((Object)null);
      return var2 != null ? new FueledProcessingInventoryObjectEntity.NextProcessTask(var2.getRecipeHash(), this.getProcessTime(var2)) : null;
   }

   public abstract int getProcessTime(Recipe var1);

   public boolean processInput() {
      for(int var1 = this.fuelSlots + this.inputSlots - 1; var1 >= this.fuelSlots; --var1) {
         InventoryRange var2 = new InventoryRange(this.inventory, var1, this.fuelSlots + this.inputSlots - 1);
         ...
         while(var3.hasNext()) {
            ...
            if (var4.canCraftRange(this.getLevel(), (PlayerMob)null, (InventoryRange)var2, false).canCraft() && this.canAddOutput(new InventoryItem[]{var4.resultItem.copy(var4.resultAmount)})) {
               FueledProcessingTechRecipeCraftedEvent var5 = new FueledProcessingTechRecipeCraftedEvent(var4, var4.craftRange(this.getLevel(), (PlayerMob)null, (InventoryRange)var2), this);
   ...
   private class TechProcessingHelp extends ProcessingHelp {
      ...
      public void update() {
         ...
         InventoryRange var1 = FueledProcessingTechInventoryObjectEntity.this.getInputInventoryRange();

         int var2;
         InventoryRange var3;
         for(var2 = var1.endSlot; var2 >= var1.startSlot; --var2) {
            var3 = new InventoryRange(FueledProcessingTechInventoryObjectEntity.this.inventory, var2, var1.endSlot);
            Iterator var4 = Recipes.getRecipes(FueledProcessingTechInventoryObjectEntity.this.techs).iterator();

            while(var4.hasNext()) {
               Recipe var5 = (Recipe)var4.next();
               CanCraft var6 = var5.canCraftRange(FueledProcessingTechInventoryObjectEntity.this.getLevel(), (PlayerMob)null, (InventoryRange)var3, FueledProcessingTechInventoryObjectEntity.this.isClient());
               if (var6.canCraft()) {
         ...
         if (this.currentRecipe == null) {
            Iterator var7 = Recipes.getRecipes(FueledProcessingTechInventoryObjectEntity.this.techs).iterator();

            while(var7.hasNext()) {
               Recipe var8 = (Recipe)var7.next();
               CanCraft var11 = var8.canCraftRange(FueledProcessingTechInventoryObjectEntity.this.getLevel(), (PlayerMob)null, (InventoryRange)var1, FueledProcessingTechInventoryObjectEntity.this.isClient());
         ...
         if (this.currentRecipe != null) {
            ...
            if (this.currentRecipe != null) {
               ...
               var3 = FueledProcessingTechInventoryObjectEntity.this.getOutputInventoryRange();
               Inventory var14 = FueledProcessingTechInventoryObjectEntity.this.inventory.copy();
               var14.addItem(FueledProcessingTechInventoryObjectEntity.this.getLevel(), (PlayerMob)null, var9, var3.startSlot, var3.endSlot, false, "add", true, false, (InventoryAddConsumer)null);

               for(var13 = var3.startSlot; var13 <= var3.endSlot; ++var13) {
                  var15 = var14.getItem(var13);
                  if (var15 != null && var15.equals(FueledProcessingTechInventoryObjectEntity.this.getLevel(), this.currentRecipe.resultItem.copy(this.currentRecipe.resultAmount), true, false, "equals")) {
