...
public class VoidTrapObjectEntity extends TrapObjectEntity {
   public static GameDamage damage = new GameDamage(35.0F, 20.0F, 0.0F, 2.0F, 1.0F);

   public VoidTrapObjectEntity(Level var1, int var2, int var3) {
   ...
   public void triggerTrap(int var1, int var2) {
      if (!this.isClient() && !this.onCooldown()) {
         if (!this.otherWireActive(var1)) {
            ...
            this.getLevel().entityManager.projectiles.add(new VoidTrapProjectile(var10003, var10004, var10005, (float)(var6 + var4.y), damage, (Mob)null));
            this.startCooldown();
         }
      }
   }
