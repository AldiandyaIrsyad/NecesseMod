...
public class MeleeFociBuff extends TrinketBuff {
   public MeleeFociBuff() {
   }
   ...
   public ListGameTooltips getTrinketTooltip(TrinketItem var1, InventoryItem var2, PlayerMob var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "meleefoci1"));
      var4.add(Localization.translate("itemtooltip", "meleefoci2"));
      return var4;
   }
}
