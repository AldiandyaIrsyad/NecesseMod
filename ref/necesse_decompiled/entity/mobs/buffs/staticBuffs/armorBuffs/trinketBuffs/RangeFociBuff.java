...
public class RangeFociBuff extends TrinketBuff {
   public RangeFociBuff() {
   }
   ...
   public ListGameTooltips getTrinketTooltip(TrinketItem var1, InventoryItem var2, PlayerMob var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "rangefoci1"));
      var4.add(Localization.translate("itemtooltip", "rangefoci2"));
      return var4;
   }
}
