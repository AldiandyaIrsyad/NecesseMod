...
public class LeatherDashersTrinketBuff extends TrinketBuff implements ActiveBuffAbility {
   public LeatherDashersTrinketBuff() {
   }
   ...
   public void onActiveAbilityStarted(PlayerMob var1, ActiveBuff var2, Packet var3) {
      ...
      var1.buffManager.addBuff(new ActiveBuff(BuffRegistry.LEATHER_DASHERS_ACTIVE, var1, 1.0F, (Attacker)null), false);
   }

   public boolean tickActiveAbility(PlayerMob var1, ActiveBuff var2, boolean var3) {
      if (var1.inLiquid()) {
         var1.buffManager.removeBuff(BuffRegistry.LEATHER_DASHERS_ACTIVE, false);
      } else {
         ActiveBuff var4 = var1.buffManager.getBuff(BuffRegistry.LEATHER_DASHERS_ACTIVE);
         if (var4 != null) {
