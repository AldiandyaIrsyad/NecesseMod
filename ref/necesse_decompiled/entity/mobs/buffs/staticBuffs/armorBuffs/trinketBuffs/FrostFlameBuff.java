...
public class FrostFlameBuff extends TrinketBuff {
   public FrostFlameBuff() {
   }
   ...
   public ListGameTooltips getTrinketTooltip(TrinketItem var1, InventoryItem var2, PlayerMob var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "frostflametip"));
      return var4;
   }
   ...
   public void onHasAttacked(ActiveBuff var1, MobWasHitEvent var2) {
      ...
      if (!var2.wasPrevented) {
         var2.target.buffManager.addBuff(new ActiveBuff(BuffRegistry.Debuffs.FROSTBURN, var2.target, 5.0F, var2.attacker), var2.target.isServer());
      }
