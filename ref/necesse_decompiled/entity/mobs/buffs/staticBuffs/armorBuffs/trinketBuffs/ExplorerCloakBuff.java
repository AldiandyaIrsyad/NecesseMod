...
public class ExplorerCloakBuff extends OutOfCombatBuff {
   public ExplorerCloakBuff() {
   }
   ...
   protected void updateActive(ActiveBuff var1, boolean var2) {
      var1.setModifier(BuffModifiers.TRAVEL_DISTANCE, 1);
      var1.setModifier(BuffModifiers.BIOME_VIEW_DISTANCE, 1);
      if (var2) {
   ...
   public ListGameTooltips getTrinketTooltip(TrinketItem var1, InventoryItem var2, PlayerMob var3) {
      ...
      var4.add(Localization.translate("itemtooltip", "piratetelescope"));
      return var4;
   }
}
