...
public class FrostSetBonusBuff extends SetBonusBuff {
   public FrostSetBonusBuff() {
   }
   ...
   public void onHasAttacked(ActiveBuff var1, MobWasHitEvent var2) {
      ...
      if (!var2.wasPrevented && var2.damageType == DamageTypeRegistry.MELEE) {
         var2.target.buffManager.addBuff(new ActiveBuff(BuffRegistry.Debuffs.FREEZING, var2.target, 5.0F, var2.attacker), var2.target.isServer());
      }
   ...
   public ListGameTooltips getTooltip(ActiveBuff var1, GameBlackboard var2) {
      ...
      var3.add(Localization.translate("itemtooltip", "frostset"));
      return var3;
   }
