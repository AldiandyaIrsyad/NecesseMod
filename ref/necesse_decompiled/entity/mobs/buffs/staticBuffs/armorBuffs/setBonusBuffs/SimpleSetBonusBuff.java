...
public class SimpleSetBonusBuff extends SetBonusBuff {
   protected ModifierValue<?>[] modifiers;

   public SimpleSetBonusBuff(ModifierValue<?>... var1) {
      this.modifiers = var1;
   }
   ...
   public void init(ActiveBuff var1, BuffEventSubscriber var2) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         var1.setModifier(var6.modifier, var6.value);
         if (var6.limits.hasMin()) {
            var1.setMinModifier(var6.modifier, var6.limits.min());
         }

         if (var6.limits.hasMax()) {
            var1.setMaxModifier(var6.modifier, var6.limits.max());
         }
      }
   ...
   public void addStatTooltips(LinkedList<ItemStatTip> var1, ActiveBuff var2, ActiveBuff var3) {
      ...
      ModifierValue[] var4 = this.modifiers;
