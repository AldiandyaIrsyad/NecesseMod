...
public class WidowSetBonusBuff extends SetBonusBuff {
   ...
   public void onHasAttacked(ActiveBuff var1, MobWasHitEvent var2) {
      ...
      if (!var2.wasPrevented) {
         var2.target.buffManager.addBuff(new ActiveBuff(BuffRegistry.Debuffs.WIDOW_POISON, var2.target, 5.0F, var2.attacker), var2.target.isServer());
      }
   ...
   public ListGameTooltips getTooltip(ActiveBuff var1, GameBlackboard var2) {
      ...
      var3.add(Localization.translate("itemtooltip", "widowset"));
      return var3;
   }
