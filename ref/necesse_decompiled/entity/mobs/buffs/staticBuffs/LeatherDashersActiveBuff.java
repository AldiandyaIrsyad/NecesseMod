...
public class LeatherDashersActiveBuff extends Buff implements MovementTickBuff {
   ...
   public void init(ActiveBuff var1, BuffEventSubscriber var2) {
      ...
      var1.setModifier(BuffModifiers.SPEED, 0.25F);
   }
   ...
   public void tickMovement(ActiveBuff var1, float var2) {
      ...
      if (var3.isClient() && (var3.dx != 0.0F || var3.dy != 0.0F)) {
         ...
         if (var6 >= 15.0F) {
            ...
            var3.getLevel().entityManager.addParticle(var10001, var10002, Particle.GType.IMPORTANT_COSMETIC).color(new Color(217, 166, 125)).sizeFadesInAndOut(10, 16, 50, 200).movesConstant(var3.dx / 10.0F, var3.dy / 10.0F).lifeTime(300).height(2.0F);
         }
         ...
         if (var7 >= 45.0F) {
            var7 -= 45.0F;
            Screen.playSound(GameResources.run, SoundEffect.effect(var3).volume(0.8F).pitch(1.8F));
         }
