...
public class MobMovementSpiralRelative extends MobMovementSpiral {
   ...
   public MobMovementSpiralRelative(Mob var1, Mob var2, float var3, int var4, float var5, float var6, float var7, boolean var8) {
      super(var1, var3, var4, var5, var6, var7, var8);
      this.targetMob = var2;
      this.targetUniqueID = var2.getUniqueID();
   }

   public MobMovementSpiralRelative(Mob var1, Mob var2, float var3, int var4, float var5, float var6, boolean var7) {
      super(var1, var2.x, var2.y, var3, var4, var5, var6, var7);
      this.targetMob = var2;
      this.targetUniqueID = var2.getUniqueID();
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof MobMovementSpiralRelative)) {
         return false;
      } else {
         MobMovementSpiralRelative var2 = (MobMovementSpiralRelative)var1;
