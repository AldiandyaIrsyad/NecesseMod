...
public class CowMob extends HusbandryMob {
   ...
   public void addSaveData(SaveData var1) {
      ...
      var1.addLong("nextMilkTime", this.nextMilkTime);
   }

   public void applyLoadData(LoadData var1) {
      super.applyLoadData(var1);
      this.nextMilkTime = var1.getLong("nextMilkTime", 0L, false);
   }

   public void applyMovementPacket(PacketReader var1, boolean var2) {
      super.applyMovementPacket(var1, var2);
      this.nextMilkTime = var1.getNextLong();
   }

   public void setupMovementPacket(PacketWriter var1) {
      super.setupMovementPacket(var1);
      var1.putNextLong(this.nextMilkTime);
   }

   public GameMessage getLocalization() {
      return (GameMessage)(this.isGrown() ? super.getLocalization() : new LocalMessage("mob", "calf"));
   }
   ...
   private GameTexture getTexture() {
      return this.isGrown() ? MobRegistry.Textures.cow : MobRegistry.Textures.calf;
   }
   ...
   public boolean canMilk(InventoryItem var1) {
      return this.isGrown() && this.nextMilkTime <= this.getWorldEntity().getWorldTime();
   }

   public InventoryItem onMilk(InventoryItem var1, List<InventoryItem> var2) {
      long var3 = (long)((this.getWorldEntity().getDayTimeMax() - this.getWorldEntity().getDayTimeInt()) * 1000);
      this.nextMilkTime = this.getWorldEntity().getWorldTime() + Math.max(var3, 120000L);
      var2.add(new InventoryItem("milk"));
