...
public class SnowHareMob extends CritterMob {
   ...
   public void spawnDeathParticles(float var1, float var2) {
      for(int var3 = 0; var3 < 4; ++var3) {
         this.getLevel().entityManager.addParticle((Particle)(new FleshParticle(this.getLevel(), MobRegistry.Textures.snowHare, var3, 8, 32, this.x, this.y, 20.0F, var1, var2)), Particle.GType.IMPORTANT_COSMETIC);
      }
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      final TextureDrawOptionsEnd var15 = MobRegistry.Textures.snowHare.initDraw().sprite(var13.x, var13.y, 64).mirror(var14, false).light(var10).pos(var11, var12);
   ...
   public MobSpawnLocation checkSpawnLocation(MobSpawnLocation var1) {
      return super.checkSpawnLocation(var1).checkTile((var1x, var2) -> {
         ...
         return var3 == TileRegistry.snowID || var3 == TileRegistry.iceID;
      });
   }
}
