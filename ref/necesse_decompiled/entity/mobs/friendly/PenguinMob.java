...
public class PenguinMob extends FriendlyRopableMob {
   public static LootTable lootTable = new LootTable(new LootItemInterface[]{new ChanceLootItem(0.02F, "weticicle")});
   ...
   public void spawnDeathParticles(float var1, float var2) {
      for(int var3 = 0; var3 < 4; ++var3) {
         this.getLevel().entityManager.addParticle((Particle)(new FleshParticle(this.getLevel(), MobRegistry.Textures.penguin, var3, 4, 32, this.x, this.y, 20.0F, var1, var2)), Particle.GType.IMPORTANT_COSMETIC);
      }
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      final TextureDrawOptionsEnd var14 = MobRegistry.Textures.penguin.initDraw().sprite(var13.x, var13.y, 32).light(var10).pos(var11, var12);
