...
public class SetEquipmentFilterSettingAction extends ContainerCustomAction {
   public final ShopContainer container;

   public SetEquipmentFilterSettingAction(ShopContainer var1) {
      this.container = var1;
   }
         ...
         if (var2 != null) {
            ...
            switch (var3) {
               case 0:
                  ...
                  (new SettlementSettlerEquipmentFilterChangedEvent(this.container.humanShop.getUniqueID(), var2.preferArmorSets, (ItemCategoriesFilterChange)null)).applyAndSendToClientsAt(this.container.client.getServerClient());
                  break;
               case 1:
                  ItemCategoriesFilterChange var4 = ItemCategoriesFilterChange.fromPacket(var1);
                  if (var4.applyTo(var2.equipmentFilter)) {
                     (new SettlementSettlerEquipmentFilterChangedEvent(this.container.humanShop.getUniqueID(), var2.preferArmorSets, var4)).applyAndSendToClientsAt(this.container.client.getServerClient());
                  }
            }
         }
      }
