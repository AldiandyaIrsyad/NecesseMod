...
public class BlacksmithHumanMob extends HumanShop {
   ...
   public void spawnDeathParticles(float var1, float var2) {
      for(int var3 = 0; var3 < 4; ++var3) {
         this.getLevel().entityManager.addParticle((Particle)(new FleshParticle(this.getLevel(), MobRegistry.Textures.blacksmith.body, GameRandom.globalRandom.nextInt(5), 8, 32, this.x, this.y, 10.0F, var1, var2)), Particle.GType.IMPORTANT_COSMETIC);
      }
   ...
   public DrawOptions getUserDrawOptions(Level var1, int var2, int var3, TickManager var4, GameCamera var5, PlayerMob var6, Consumer<HumanDrawOptions> var7) {
      ...
      HumanDrawOptions var12 = (new HumanDrawOptions(var1, MobRegistry.Textures.blacksmith)).helmet(this.getDisplayArmor(0, (String)null)).chestplate(this.getDisplayArmor(1, "smithingapron")).boots(this.getDisplayArmor(2, "smithingshoes")).invis((Boolean)this.buffManager.getModifier(BuffModifiers.INVISIBILITY)).sprite(var11).dir(this.dir).light(var8);
      var7.accept(var12);
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      if (this.objectUser == null || this.objectUser.object.drawsUsers()) {
         if (this.isVisible()) {
            ...
            HumanDrawOptions var14 = (new HumanDrawOptions(var4, MobRegistry.Textures.blacksmith)).helmet(this.getDisplayArmor(0, (String)null)).chestplate(this.getDisplayArmor(1, "smithingapron")).boots(this.getDisplayArmor(2, "smithingshoes")).invis((Boolean)this.buffManager.getModifier(BuffModifiers.INVISIBILITY)).sprite(var13).dir(this.dir).light(var10);
   ...
   protected ArrayList<GameMessage> getMessages(ServerClient var1) {
      ArrayList var2 = this.getLocalMessages("blacksmithtalk", 4);
      HumanMob var3 = this.getRandomHuman("gunsmith");
      if (var3 != null) {
         var2.add(new LocalMessage("mobmsg", "blacksmithspecial", "gunsmith", var3.getSettlerName()));
      }
   ...
   public List<InventoryItem> getRecruitItems(ServerClient var1) {
      if (this.isSettler()) {
         ...
         GameRandom var2 = new GameRandom((long)(this.getSettlerSeed() * 29));
         if (this.isTravelingHuman()) {
            return Collections.singletonList(new InventoryItem("coin", var2.getIntBetween(200, 400)));
         } else {
   ...
   public ArrayList<ShopItem> getShopItems(VillageShopsData var1, ServerClient var2) {
      if (this.isTravelingHuman()) {
         ...
         addBarBuyRecipes(this, var3, var1, var2, var4);
         var3.add(ShopItem.item("ironpickaxe", this.getRandomHappinessPrice(var4, 40, 120, 40)));
         var3.add(ShopItem.item("ironfishingrod", this.getRandomHappinessPrice(var4, 200, 400, 50)));
         return var3;
      }
   }

   public static void addBarBuyRecipes(HumanShop var0, List<ShopItem> var1, VillageShopsData var2, ServerClient var3, GameRandom var4) {
      ShopItem.addStockedItem(var1, var2, "copperbar", var0.getRandomHappinessPrice(var4, -10, -4, 2));
      ShopItem.addStockedItem(var1, var2, "ironbar", var0.getRandomHappinessPrice(var4, -12, -6, 2));
      ShopItem.addStockedItem(var1, var2, "goldbar", var0.getRandomHappinessPrice(var4, -18, -10, 2));
      ShopItem.addStockedItem(var1, var2, "brokencoppertool", var0.getRandomHappinessPrice(var4, -60, -20, 10));
      ShopItem.addStockedItem(var1, var2, "brokenirontool", var0.getRandomHappinessPrice(var4, -70, -30, 10));
      conditionSection(var4, var3.characterStats().mob_kills.getKills("evilsprotector") > 0, (var3x) -> {
         ShopItem.addStockedItem(var1, var2, "demonicbar", var0.getRandomHappinessPrice(var3x, -18, -10, 2));
         ShopItem.addStockedItem(var1, var2, "quartz", var0.getRandomHappinessPrice(var3x, -25, -15, 3));
      });
      conditionSection(var4, var3.characterStats().mob_kills.getKills("piratecaptain") > 0, (var3x) -> {
         ShopItem.addStockedItem(var1, var2, "obsidian", var0.getRandomHappinessPrice(var3x, -8, -2, 2));
         ShopItem.addStockedItem(var1, var2, "lifequartz", var0.getRandomHappinessPrice(var3x, -35, -20, 5));
         ShopItem.addStockedItem(var1, var2, "tungstenbar", var0.getRandomHappinessPrice(var3x, -35, -20, 5));
         ShopItem.addStockedItem(var1, var2, "glacialbar", var0.getRandomHappinessPrice(var3x, -35, -20, 5));
         ShopItem.addStockedItem(var1, var2, "myceliumbar", var0.getRandomHappinessPrice(var3x, -35, -20, 5));
         ShopItem.addStockedItem(var1, var2, "ancientfossilbar", var0.getRandomHappinessPrice(var3x, -35, -20, 5));
      });
   }
}
