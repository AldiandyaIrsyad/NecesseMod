...
public class ExplorerHumanMob extends HumanShop {
   ...
   public void addSaveData(SaveData var1) {
      ...
      if (this.foundIslandCoord != null) {
         var1.addPoint("foundIslandCoord", this.foundIslandCoord);
      }

      var1.addBoolean("foundIsland", this.foundIsland);
   }

   public void applyLoadData(LoadData var1) {
      super.applyLoadData(var1);
      this.foundIslandCoord = var1.getPoint("foundIslandCoord", this.foundIslandCoord, false);
      this.foundIsland = var1.getBoolean("foundIsland", this.foundIsland, false);
   }

   public void setupMovementPacket(PacketWriter var1) {
      super.setupMovementPacket(var1);
      var1.putNextBoolean(this.isLost);
      var1.putNextBoolean(this.foundIsland);
      var1.putNextBoolean(this.foundIslandCoord != null);
      if (this.foundIslandCoord != null) {
         var1.putNextInt(this.foundIslandCoord.x);
         var1.putNextInt(this.foundIslandCoord.y);
      }
   ...
   public void applyMovementPacket(PacketReader var1, boolean var2) {
      ...
      this.foundIsland = var1.getNextBoolean();
      if (var1.getNextBoolean()) {
         int var3 = var1.getNextInt();
         int var4 = var1.getNextInt();
         this.foundIslandCoord = new Point(var3, var4);
      } else {
         this.foundIslandCoord = null;
      }
   ...
   public void spawnDeathParticles(float var1, float var2) {
      for(int var3 = 0; var3 < 4; ++var3) {
         this.getLevel().entityManager.addParticle((Particle)(new FleshParticle(this.getLevel(), MobRegistry.Textures.explorer.body, GameRandom.globalRandom.nextInt(5), 8, 32, this.x, this.y, 10.0F, var1, var2)), Particle.GType.IMPORTANT_COSMETIC);
      }
   ...
   public DrawOptions getUserDrawOptions(Level var1, int var2, int var3, TickManager var4, GameCamera var5, PlayerMob var6, Consumer<HumanDrawOptions> var7) {
      ...
      HumanDrawOptions var12 = (new HumanDrawOptions(var1, MobRegistry.Textures.explorer)).helmet(this.getDisplayArmor(0, "safarihat")).chestplate(this.getDisplayArmor(1, "safarishirt")).boots(this.getDisplayArmor(2, "safarishoes")).invis((Boolean)this.buffManager.getModifier(BuffModifiers.INVISIBILITY)).sprite(var11).dir(this.dir).light(var8);
      var7.accept(var12);
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      if (this.objectUser == null || this.objectUser.object.drawsUsers()) {
         if (this.isVisible()) {
            ...
            HumanDrawOptions var14 = (new HumanDrawOptions(var4, MobRegistry.Textures.explorer)).helmet(this.getDisplayArmor(0, "safarihat")).chestplate(this.getDisplayArmor(1, "safarishirt")).boots(this.getDisplayArmor(2, "safarishoes")).invis((Boolean)this.buffManager.getModifier(BuffModifiers.INVISIBILITY)).sprite(var13).dir(this.dir).light(var10);
   ...
   public QuestMarkerOptions getMarkerOptions(PlayerMob var1) {
      if (this.isTravelingHuman()) {
         ...
         return this.foundIsland ? new QuestMarkerOptions('?', this.foundIslandCoord == null ? QuestMarkerOptions.grayColor : QuestMarkerOptions.orangeColor) : super.getMarkerOptions(var1);
      }
   }
   ...
   public List<InventoryItem> getRecruitItems(ServerClient var1) {
      if (this.isSettler()) {
         ...
         if (this.isTravelingHuman()) {
            return Collections.singletonList(new InventoryItem("coin", var2.getIntBetween(300, 500)));
         } else {
            LootTable var3 = new LootTable(new LootItemInterface[]{new CountOfTicketLootItems(var2.getIntBetween(1, 2), new Object[]{100, new LootItem("quartz", Integer.MAX_VALUE), 100, new LootItem("ironore", Integer.MAX_VALUE), 100, new LootItem("goldore", Integer.MAX_VALUE), 100, new LootItem("quartz", Integer.MAX_VALUE)})});
            ArrayList var4 = GameLootUtils.getItemsValuedAt(var2, var2.getIntBetween(200, 300), 0.20000000298023224, new LootItem("coin", Integer.MAX_VALUE));
            var4.addAll(GameLootUtils.getItemsValuedAt(var2, var2.getIntBetween(50, 75), 0.20000000298023224, var3));
   ...
   public Stream<ModifierValue<?>> getDefaultModifiers() {
      return !this.isSettler() ? Stream.concat(Stream.of(new ModifierValue(BuffModifiers.INCOMING_DAMAGE_MOD, 0.5F)), super.getDefaultModifiers()) : super.getDefaultModifiers();
   }
   ...
   public List<ExpeditionList> getPossibleExpeditions() {
      if (this.isSettlerOnCurrentLevel()) {
         ...
         if (var1 != null) {
            ExpeditionList var2 = new ExpeditionList(new LocalMessage("ui", "explorerexpeditions"), new LocalMessage("ui", "explorerselectexp"), new LocalMessage("ui", "explorerexpcost"), new LocalMessage("ui", "explorershowmore"), var1, this, (List)ExpeditionMissionRegistry.explorerExpeditionIDs.stream().map(ExpeditionMissionRegistry::getExpedition).collect(Collectors.toList()));
   ...
   public GameMessage getWorkInvMessage() {
      return (GameMessage)(this.completedMission ? new LocalMessage("ui", "explorerexpcomplete") : super.getWorkInvMessage());
   }
   ...
   public PacketOpenContainer getOpenShopPacket(Server var1, ServerClient var2) {
      return PacketOpenContainer.Mob(ContainerRegistry.EXPLORER_CONTAINER, this, ExplorerContainer.getExplorerContainerContent(this, var1, var2, this.getShopItemsContentPacket(var2)));
   }

   protected void addDebugTooltips(ListGameTooltips var1) {
      super.addDebugTooltips(var1);
      var1.add("foundIsland: " + this.foundIsland);
      var1.add("foundIslandCoord: " + this.foundIslandCoord);
   }
}
