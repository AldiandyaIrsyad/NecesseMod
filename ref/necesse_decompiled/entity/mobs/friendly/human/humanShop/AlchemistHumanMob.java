...
public class AlchemistHumanMob extends HumanShop {
   ...
   public void spawnDeathParticles(float var1, float var2) {
      for(int var3 = 0; var3 < 4; ++var3) {
         this.getLevel().entityManager.addParticle((Particle)(new FleshParticle(this.getLevel(), MobRegistry.Textures.alchemist.body, GameRandom.globalRandom.nextInt(5), 8, 32, this.x, this.y, 10.0F, var1, var2)), Particle.GType.IMPORTANT_COSMETIC);
      }
   ...
   public DrawOptions getUserDrawOptions(Level var1, int var2, int var3, TickManager var4, GameCamera var5, PlayerMob var6, Consumer<HumanDrawOptions> var7) {
      ...
      HumanDrawOptions var12 = (new HumanDrawOptions(var1, MobRegistry.Textures.alchemist)).helmet(this.getDisplayArmor(0, (String)null)).chestplate(this.getDisplayArmor(1, "labcoat")).boots(this.getDisplayArmor(2, "labboots")).invis((Boolean)this.buffManager.getModifier(BuffModifiers.INVISIBILITY)).sprite(var11).dir(this.dir).light(var8);
      var7.accept(var12);
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      if (this.objectUser == null || this.objectUser.object.drawsUsers()) {
         if (this.isVisible()) {
            ...
            HumanDrawOptions var14 = (new HumanDrawOptions(var4, MobRegistry.Textures.alchemist)).helmet(this.getDisplayArmor(0, (String)null)).chestplate(this.getDisplayArmor(1, "labcoat")).boots(this.getDisplayArmor(2, "labboots")).invis((Boolean)this.buffManager.getModifier(BuffModifiers.INVISIBILITY)).sprite(var13).dir(this.dir).light(var10);
   ...
   public PacketOpenContainer getOpenShopPacket(Server var1, ServerClient var2) {
      return PacketOpenContainer.Mob(ContainerRegistry.ALCHEMIST_CONTAINER, this, this.getShopItemsContentPacket(var2));
   }
   ...
   public List<InventoryItem> getRecruitItems(ServerClient var1) {
      if (this.isSettler()) {
         ...
         GameRandom var2 = new GameRandom((long)(this.getSettlerSeed() * 89));
         if (this.isTravelingHuman()) {
            return Collections.singletonList(new InventoryItem("coin", var2.getIntBetween(200, 400)));
         } else {
            LootTable var3 = new LootTable(new LootItemInterface[]{new CountOfTicketLootItems(2, new Object[]{100, new LootItem("sunflower", Integer.MAX_VALUE), 100, new LootItem("firemone", Integer.MAX_VALUE), 100, new LootItem("iceblossom", Integer.MAX_VALUE), 100, new LootItem("mushroom", Integer.MAX_VALUE)})});
            ...
            var4.addAll(GameLootUtils.getItemsValuedAt(var2, var2.getIntBetween(75, 100), 0.20000000298023224, var3));
   ...
   public ArrayList<ShopItem> getShopItems(VillageShopsData var1, ServerClient var2) {
      if (this.isTravelingHuman()) {
         ...
         ShopItem.addStockedItem(var3, var1, "healthpotion", this.getRandomHappinessPrice(var4, 5, 25, 5));
         ShopItem.addStockedItem(var3, var1, "manapotion", this.getRandomHappinessPrice(var4, 5, 25, 5));
         ShopItem.addStockedItem(var3, var1, "speedpotion", this.getRandomHappinessPrice(var4, 10, 50, 10));
         ShopItem.addStockedItem(var3, var1, "healthregenpotion", this.getRandomHappinessPrice(var4, 10, 50, 10));
         ShopItem.addStockedItem(var3, var1, "attackspeedpotion", this.getRandomHappinessPrice(var4, 10, 50, 10));
         ShopItem.addStockedItem(var3, var1, "manaregenpotion", this.getRandomHappinessPrice(var4, 10, 50, 10));
         ShopItem.addStockedItem(var3, var1, "firemone", this.getRandomHappinessPrice(var4, -12, -3, 3));
         ShopItem.addStockedItem(var3, var1, "sunflower", this.getRandomHappinessPrice(var4, -12, -3, 3));
         ShopItem.addStockedItem(var3, var1, "iceblossom", this.getRandomHappinessPrice(var4, -12, -3, 3));
         ShopItem.addStockedItem(var3, var1, "caveglow", this.getRandomHappinessPrice(var4, -12, -3, 3));
         return var3;
      }
   }
}
