...
public class PlayerFollowerCollisionChaserAI<T extends Mob> extends SelectorAINode<T> {
   public PlayerFollowerCollisionChaserAI(int var1, GameDamage var2, int var3, int var4, int var5, int var6) {
