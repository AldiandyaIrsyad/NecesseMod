...
public class SucceederAINode<T extends Mob> extends DecoratorAINode<T> {
   public SucceederAINode(AINode<T> var1) {
      super(var1);
   }
   ...
   public AINodeResult tickChild(AINode<T> var1, T var2, Blackboard<T> var3) {
      ...
      return var4 == AINodeResult.RUNNING ? AINodeResult.RUNNING : AINodeResult.SUCCESS;
   }
}
