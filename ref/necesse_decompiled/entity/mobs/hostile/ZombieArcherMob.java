...
public class ZombieArcherMob extends HostileMob {
   ...
   public void init() {
      ...
      this.ai = new BehaviourTreeAI(this, new PlayerChaserWandererAI<Mob>(() -> {
         ...
         public boolean attackTarget(Mob var1, Mob var2) {
            return this.shootSimpleProjectile(var1, var2, "zombiearrow", ZombieArcherMob.damage, 60, 480);
         }
      });
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      HumanDrawOptions var15 = (new HumanDrawOptions(var4, this.isAttacking ? MobRegistry.Textures.zombieArcher : MobRegistry.Textures.zombieArcherWithBow)).sprite(var13).dir(this.dir).light(var10);
      if (this.isAttacking) {
         var15.itemAttack(new InventoryItem("woodbow"), (PlayerMob)null, var14, this.attackDir.x, this.attackDir.y);
      }
   ...
   static {
      lootTable = new LootTable(new LootItemInterface[]{LootItem.between("stonearrow", 2, 6), new ConditionLootItemList((var0, var1) -> {
         Mob var2 = (Mob)LootTable.expectExtra(Mob.class, var1, 0);
         return var2 == null || var2.getLevel().getIslandDimension() < 0;
      }, new LootItemInterface[]{ZombieMob.belowSurfaceDrop}), randomMapDrop});
      privateLootTable = new LootTable(new LootItemInterface[]{randomPrivatePortalDrop});
      damage = new GameDamage(16.0F);
   }
}
