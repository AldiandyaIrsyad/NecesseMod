...
public class ZombieMob extends HostileMob {
   public static LootItemInterface belowSurfaceDrop = new ChanceLootItemList(0.4F, new LootItemInterface[]{new OneOfTicketLootItems(new Object[]{3, new OneOfLootItems(LootItem.between("copperore", 1, 3), new LootItemInterface[]{LootItem.between("ironore", 1, 3)}), 1, new OneOfLootItems(new LootItemInterface() {
      public void addPossibleLoot(LootList var1, Object... var2) {
         var1.add("brokencoppertool");
      }

      public void addItems(List<InventoryItem> var1, GameRandom var2, float var3, Object... var4) {
         var1.add(MultiTextureMatItem.generateRandomItem("brokencoppertool", var2));
      }
   }, new LootItemInterface[]{new LootItemInterface() {
      public void addPossibleLoot(LootList var1, Object... var2) {
         var1.add("brokenirontool");
      }

      public void addItems(List<InventoryItem> var1, GameRandom var2, float var3, Object... var4) {
         var1.add(MultiTextureMatItem.generateRandomItem("brokenirontool", var2));
      }
   }})})});
   ...
   public void spawnDeathParticles(float var1, float var2) {
      for(int var3 = 0; var3 < 4; ++var3) {
         this.getLevel().entityManager.addParticle((Particle)(new FleshParticle(this.getLevel(), MobRegistry.Textures.zombie.body, GameRandom.globalRandom.nextInt(5), 8, 32, this.x, this.y, 20.0F, var1, var2)), Particle.GType.IMPORTANT_COSMETIC);
      }
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      HumanDrawOptions var14 = (new HumanDrawOptions(var4, MobRegistry.Textures.zombie)).sprite(var13).dir(this.dir).light(var10);
      if (this.hat != null) {
   ...
   static {
      lootTable = new LootTable(new LootItemInterface[]{new ConditionLootItemList((var0, var1) -> {
         ...
         return var2 == null || var2.getLevel().getIslandDimension() < 0;
      }, new LootItemInterface[]{belowSurfaceDrop}), randomMapDrop});
      privateLootTable = new LootTable(new LootItemInterface[]{randomPrivatePortalDrop});
   }
}
