...
public class EnchantedZombieMob extends HostileMob {
   ...
   public void init() {
      super.init();
      this.ai = new BehaviourTreeAI(this, new CollisionPlayerChaserWandererAI((Supplier)null, 480, new GameDamage(35.0F), 100, 40000));
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      HumanDrawOptions var14 = (new HumanDrawOptions(var4, MobRegistry.Textures.enchantedZombie)).sprite(var13).dir(this.dir).light(var10);
      if (this.hat != null) {
