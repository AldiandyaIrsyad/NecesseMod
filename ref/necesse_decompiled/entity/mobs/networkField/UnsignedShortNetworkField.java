...
public class UnsignedShortNetworkField extends NetworkField<Integer> {
   public UnsignedShortNetworkField(int var1) {
      super(var1);
   }

   public void writePacket(Integer var1, PacketWriter var2) {
      var2.putNextShortUnsigned(var1);
   }

   public Integer readPacket(PacketReader var1) {
      return var1.getNextShortUnsigned();
   }
