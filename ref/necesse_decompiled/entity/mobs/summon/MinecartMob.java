...
public class MinecartMob extends SummonedMob {
   public static LootTable lootTable = new LootTable(new LootItemInterface[]{new LootItem("minecart")});
      ...
      if (var5 instanceof MinecartTrackObject && !(var5 instanceof TrapTrackObject)) {
         ...
         if (var12 != null) {
            ...
            if (this.minecartSpeed > 0.0F) {
               ...
               this.dx = this.dir != 1 && this.dir != 3 ? 0.0F : this.minecartSpeed * (float)(this.dir == 1 ? 1 : -1);
               this.dy = this.dir != 0 && this.dir != 2 ? 0.0F : this.minecartSpeed * (float)(this.dir == 2 ? 1 : -1);
   ...
   public boolean canBeHit(Attacker var1) {
      if (!super.canBeHit(var1)) {
         return false;
      } else {
         return !(var1 instanceof ToolItemEvent) && !(var1 instanceof ExplosionEvent) ? false : var1.getAttackOwners().stream().anyMatch((var0) -> {
