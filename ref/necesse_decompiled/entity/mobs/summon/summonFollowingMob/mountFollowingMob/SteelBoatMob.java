...
public class SteelBoatMob extends MountFollowingMob {
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      final TextureDrawOptionsEnd var14 = MobRegistry.Textures.steelBoat.initDraw().sprite(var13.x, var13.y, 64).light(var10).pos(var11, var12);
   ...
   public Stream<ModifierValue<?>> getDefaultRiderModifiers() {
      return Stream.of(new ModifierValue(BuffModifiers.TRAVEL_DISTANCE, 2));
   }
}
