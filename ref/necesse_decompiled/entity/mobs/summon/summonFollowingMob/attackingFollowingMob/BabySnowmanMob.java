...
public class BabySnowmanMob extends AttackingFollowingMob {
   ...
   public void init() {
      super.init();
      this.ai = new BehaviourTreeAI(this, new PlayerFollowerChaserAI<BabySnowmanMob>(576, 320, false, false, 640, 64) {
         public boolean attackTarget(BabySnowmanMob var1, Mob var2) {
            if (var1.canAttack()) {
               var1.attack(var2.getX(), var2.getY(), false);
               Projectile var3 = ProjectileRegistry.getProjectile("snowball", var1.getLevel(), var1.x, var1.y, var2.x, var2.y, 100.0F, 640, BabySnowmanMob.this.damage, var1);
         ...
         public boolean attackTarget(Mob var1, Mob var2) {
            return this.attackTarget((BabySnowmanMob)var1, var2);
         }
      });
   }
   ...
   public void spawnDeathParticles(float var1, float var2) {
      for(int var3 = 0; var3 < 5; ++var3) {
         this.getLevel().entityManager.addParticle((Particle)(new FleshParticle(this.getLevel(), MobRegistry.Textures.babySnowman.body, var3, 6, 32, this.x, this.y, 20.0F, var1, var2)), Particle.GType.IMPORTANT_COSMETIC);
      }
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      int var12 = var8.getDrawY(var6) - 44 - 5;
      Point var13 = this.getAnimSprite(var5, var6, this.dir);
      var12 += this.getBobbing(var5, var6);
      var12 += this.getLevel().getTile(var5 / 32, var6 / 32).getMobSinkingAmount(this);
      float var14 = this.getAttackAnimProgress();
      HumanDrawOptions var15 = (new HumanDrawOptions(var4, MobRegistry.Textures.babySnowman)).sprite(var13).dir(this.dir).light(var10);
      if (this.isAttacking) {
         ItemAttackDrawOptions var16 = ItemAttackDrawOptions.start(this.dir).itemSprite(MobRegistry.Textures.babySnowman.body, 0, 9, 32).itemRotatePoint(20, 20).itemEnd().armSprite(MobRegistry.Textures.babySnowman.body, 0, 8, 32).offsets(32, 21, 12, 4, 12).swingRotation(var14).light(var10);
