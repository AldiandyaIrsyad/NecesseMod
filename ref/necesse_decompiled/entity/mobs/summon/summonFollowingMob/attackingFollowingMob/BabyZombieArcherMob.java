...
public class BabyZombieArcherMob extends AttackingFollowingMob {
   public BabyZombieArcherMob() {
      super(10);
      this.setSpeed(50.0F);
   ...
   public void init() {
      super.init();
      this.ai = new BehaviourTreeAI(this, new PlayerFollowerChaserAI<BabyZombieArcherMob>(576, 320, false, false, 640, 64) {
         public boolean attackTarget(BabyZombieArcherMob var1, Mob var2) {
            if (var1.canAttack()) {
               var1.attack(var2.getX(), var2.getY(), false);
               Projectile var3 = ProjectileRegistry.getProjectile("zombiearrow", var1.getLevel(), var1.x, var1.y, var2.x, var2.y, 80.0F, 640, BabyZombieArcherMob.this.damage, var1);
         ...
         public boolean attackTarget(Mob var1, Mob var2) {
            return this.attackTarget((BabyZombieArcherMob)var1, var2);
         }
      });
   }
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      HumanDrawOptions var15 = (new HumanDrawOptions(var4, this.isAttacking ? MobRegistry.Textures.babyZombie : MobRegistry.Textures.babyZombieArcher)).sprite(var13).dir(this.dir).light(var10);
      if (this.isAttacking) {
         ItemAttackDrawOptions var16 = ItemAttackDrawOptions.start(this.dir).itemSprite(MobRegistry.Textures.babyZombie.body, 0, 9, 32).itemRotatePoint(20, 20).itemEnd().armSprite(MobRegistry.Textures.babyZombie.body, 0, 8, 32).pointRotation(this.attackDir.x, this.attackDir.y).light(var10);
