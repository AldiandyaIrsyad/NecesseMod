...
public class BabySkeletonMob extends AttackingFollowingMob {
   ...
   public void init() {
      super.init();
      this.ai = new BehaviourTreeAI(this, new PlayerFollowerCollisionChaserAI(576, this.damage, 30, 1000, 640, 64));
   }
   ...
   public void spawnDeathParticles(float var1, float var2) {
      for(int var3 = 0; var3 < 5; ++var3) {
         this.getLevel().entityManager.addParticle((Particle)(new FleshParticle(this.getLevel(), MobRegistry.Textures.babySkeleton.body, var3, 8, 32, this.x, this.y, 20.0F, var1, var2)), Particle.GType.IMPORTANT_COSMETIC);
      }
   ...
   public void addDrawables(List<MobDrawable> var1, OrderableDrawables var2, OrderableDrawables var3, Level var4, int var5, int var6, TickManager var7, GameCamera var8, PlayerMob var9) {
      ...
      HumanDrawOptions var14 = (new HumanDrawOptions(var4, MobRegistry.Textures.babySkeleton)).sprite(var13).mirrorX((this.dir == 0 || this.dir == 2) && this.moveX < 0.1F).dir(this.dir).light(var10);
      float var15 = this.getAttackAnimProgress();
      if (this.isAttacking) {
         ItemAttackDrawOptions var16 = ItemAttackDrawOptions.start(this.dir).itemSprite(MobRegistry.Textures.babySkeleton.body, 0, 9, 32).itemRotatePoint(4, 4).itemEnd().armSprite(MobRegistry.Textures.babySkeleton.body, 0, 8, 32).swingRotation(var15).light(var10);
