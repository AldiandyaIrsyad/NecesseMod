...
public class GritBoomerangProjectile extends BoomerangProjectile {
   public GritBoomerangProjectile() {
   }
   ...
   public Trail getTrail() {
      return new Trail(this, this.getLevel(), new Color(184, 102, 40), 25.0F, 700, 18.0F);
   }
