...
public class CausticExecutionerProjectile extends Projectile {
   private boolean hitMob = false;

   public CausticExecutionerProjectile() {
   }

   public CausticExecutionerProjectile(Level var1, float var2, float var3, float var4, float var5, int var6, GameDamage var7, Mob var8) {
      this.setLevel(var1);
      this.x = var2;
      this.y = var3;
   ...
   public void spawnSprayParticles(int var1) {
      ...
      for(int var3 = 0; var3 < var1; ++var3) {
         float var4 = this.x + GameRandom.globalRandom.floatGaussian() * 30.0F;
         float var5 = this.y + GameRandom.globalRandom.floatGaussian() * 30.0F;
         ...
         float var10 = GameRandom.globalRandom.getFloatBetween(16.0F, 40.0F);
         ...
         this.getLevel().entityManager.addParticle(var4, var5, var2.next()).fadesAlphaTime(0, var17).color(new Color(166, 204, 52)).sizeFadesInAndOut(12, 24, 100, 0).sprite(GameResources.puffParticles.sprite(0, GameRandom.globalRandom.nextInt(4), 12)).height((ParticleOption.HeightGetter)var19).rotates().moves((var4x, var5x, var6x, var7x, var8x) -> {
