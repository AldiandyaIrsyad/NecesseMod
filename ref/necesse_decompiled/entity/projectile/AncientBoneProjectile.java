...
public class AncientBoneProjectile extends Projectile {
   private long spawnTime;

   public AncientBoneProjectile() {
   }

   public AncientBoneProjectile(float var1, float var2, float var3, float var4, GameDamage var5, Mob var6) {
      this.x = var1;
      this.y = var2;
   ...
   public Trail getTrail() {
      return new Trail(this, this.getLevel(), new Color(159, 147, 124), 10.0F, 250, 18.0F);
   }
