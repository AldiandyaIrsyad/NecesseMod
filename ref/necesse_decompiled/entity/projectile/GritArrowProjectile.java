...
public class GritArrowProjectile extends Projectile {
   public GritArrowProjectile() {
   }

   public GritArrowProjectile(Mob var1, float var2, float var3, float var4, float var5, float var6, int var7, GameDamage var8, int var9) {
      this.setOwner(var1);
      this.x = var2;
      this.y = var3;
