...
public class AncientVultureProjectile extends Projectile {
   public AncientVultureProjectile() {
   }

   public AncientVultureProjectile(Mob var1, int var2, int var3, int var4, int var5, GameDamage var6) {
      this.setOwner(var1);
      this.x = (float)var2;
      this.y = (float)var3;
   ...
   public Trail getTrail() {
      return new Trail(this, this.getLevel(), new Color(65, 59, 21), 16.0F, 100, this.getHeight());
   }
