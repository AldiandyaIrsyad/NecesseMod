...
public class SwampDwellerStaffPetalProjectile extends Projectile {
   public SwampDwellerStaffPetalProjectile() {
   }

   public SwampDwellerStaffPetalProjectile(Level var1, Mob var2, float var3, float var4, float var5, float var6, float var7, int var8, GameDamage var9, int var10) {
      this.setLevel(var1);
      this.setOwner(var2);
      this.x = var3;
      this.y = var4;
