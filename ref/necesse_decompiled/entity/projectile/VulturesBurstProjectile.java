...
public class VulturesBurstProjectile extends Projectile {
   public VulturesBurstProjectile() {
   }

   public VulturesBurstProjectile(Mob var1, float var2, float var3, float var4, float var5, float var6, int var7, GameDamage var8, int var9) {
      this.setOwner(var1);
      this.x = var2;
      this.y = var3;
   ...
   public Trail getTrail() {
      return new Trail(this, this.getLevel(), new Color(199, 194, 148), 12.0F, 500, this.getHeight());
   }
