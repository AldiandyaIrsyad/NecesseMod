...
public class SlimeGreatBowArrowProjectile extends Projectile {
   ...
   public SlimeGreatBowArrowProjectile(Level var1, Mob var2, float var3, float var4, float var5, float var6, float var7, int var8, GameDamage var9, float var10, int var11, Point2D.Float var12, boolean var13) {
      this.setLevel(var1);
      this.setOwner(var2);
      this.x = var3;
      this.y = var4;
   ...
   public void doHitLogic(Mob var1, LevelObjectHit var2, float var3, float var4) {
      ...
      if (!this.isFallingProjectile) {
         SlimeGreatBowArrowProjectile var5 = new SlimeGreatBowArrowProjectile(this.getLevel(), this.getOwner(), this.targetPoints.x, this.targetPoints.y - (float)this.distance, this.targetPoints.x, this.targetPoints.y, this.speed, this.distance, this.damage, this.eventResilienceGain, this.knockback, (Point2D.Float)null, true);
         var5.getUniqueID((new GameRandom((long)this.getUniqueID())).nextSeeded(68));
         ...
         if (!this.isServer()) {
            ...
            var9.colorGetter = (var0, var1x, var2x) -> {
               return ParticleOption.randomizeColor(175.0F, 0.6F, 0.8F, 2.0F, 0.0F, 0.0F);
            };
            var9.trailChance = 0.0F;
            var9.particles = 40;
            var9.lifetime = var7;
         ...
         this.getLevel().entityManager.addLevelEventHidden(new SlimeGreatbowEvent(this.getOwner(), (int)var3, (int)var4, new GameRandom((long)this.getUniqueID()), this.getDamage(), this.eventResilienceGain, this.knockback));
      }
   ...
   public Trail getTrail() {
      Trail var1 = new Trail(this, this.getLevel(), new Color(70, 178, 170), 16.0F, 200, this.getHeight());
      var1.drawOnTop = true;
      return var1;
   }
