...
public class WoodBoomerangProjectile extends BoomerangProjectile {
   public WoodBoomerangProjectile() {
   }
   ...
   public Trail getTrail() {
      return new Trail(this, this.getLevel(), new Color(150, 150, 150), 25.0F, 250, 18.0F);
   }
