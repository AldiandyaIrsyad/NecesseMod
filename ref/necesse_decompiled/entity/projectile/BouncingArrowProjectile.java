...
public class BouncingArrowProjectile extends Projectile {
   public BouncingArrowProjectile() {
   }
   ...
   public Trail getTrail() {
      return new Trail(this, this.getLevel(), new Color(70, 70, 255), 10.0F, 250, 18.0F);
   }
   ...
   public void dropItem() {
      if (GameRandom.globalRandom.getChance(0.5F)) {
         this.getLevel().entityManager.pickups.add((new InventoryItem("bouncingarrow")).getPickupEntity(this.getLevel(), this.x, this.y));
      }
