...
public class BouncingSlimeBallProjectile extends Projectile {
   ...
   public BouncingSlimeBallProjectile(Level var1, Mob var2, float var3, float var4, float var5, float var6, float var7, int var8, GameDamage var9, int var10) {
      this.setLevel(var1);
      this.x = var3;
      this.y = var4;
      this.speed = var7;
   ...
   public float tickMovement(float var1) {
      ...
      this.bouncingHeight += this.deltaHeight * var1 / 250.0F;
      if (this.bouncingHeight < 0.0F) {
         if (this.isClient()) {
            Screen.playSound(GameResources.slimesplash, SoundEffect.effect(this).volume(0.1F).pitch(0.9F));
            ExplosionEvent.spawnExplosionParticles(this.getLevel(), this.x, this.y, 10, 0.0F, 12.0F, (var0, var1x, var2x, var3x, var4, var5, var6) -> {
               var0.entityManager.addParticle(var1x, var2x, Particle.GType.CRITICAL).movesConstant(var3x, var4).color(new Color(154, 32, 176)).lifeTime(var5);
            });
         }
   ...
   public Trail getTrail() {
      Trail var1 = new Trail(this, this.getLevel(), new Color(124, 19, 136), 16.0F, 500, this.getHeight());
