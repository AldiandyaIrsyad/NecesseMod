...
public class BoneArrowProjectile extends Projectile {
   public BoneArrowProjectile() {
   }
   ...
   public void dropItem() {
      if (GameRandom.globalRandom.getChance(0.5F)) {
         this.getLevel().entityManager.pickups.add((new InventoryItem("bonearrow")).getPickupEntity(this.getLevel(), this.x, this.y));
      }
