...
public class MageSlimeBoltProjectile extends FollowingProjectile {
   public MageSlimeBoltProjectile() {
   }

   public MageSlimeBoltProjectile(Level var1, Mob var2, float var3, float var4, float var5, float var6, float var7, int var8, GameDamage var9, int var10) {
      this.setLevel(var1);
      this.x = var3;
      this.y = var4;
      this.speed = var7;
   ...
   public Trail getTrail() {
      return new Trail(this, this.getLevel(), new Color(32, 131, 176), 16.0F, 500, 10.0F);
   }
