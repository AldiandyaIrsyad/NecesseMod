...
class FireChaliceObject3 extends FireChaliceAbstractObject {
   protected int counterIDTopLeft;
   protected int counterIDTopRight;
   protected int counterIDBotRight;

   public FireChaliceObject3(String var1, Color var2) {
      super(var1, var2);
   }
   ...
   protected Rectangle getCollision(Level var1, int var2, int var3, int var4) {
      if (var4 == 0) {
         ...
         return var4 == 2 ? new Rectangle(var2 * 32, var3 * 32 + 5, 28, 27) : new Rectangle(var2 * 32, var3 * 32, 28, 24);
      }
   }
