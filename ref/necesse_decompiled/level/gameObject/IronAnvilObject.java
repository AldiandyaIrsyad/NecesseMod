...
public class IronAnvilObject extends CraftingStationObject {
   public GameTexture texture;

   public IronAnvilObject() {
      super(new Rectangle(32, 32));
      this.mapColor = new Color(175, 175, 175);
   ...
   public void loadTextures() {
      super.loadTextures();
      this.texture = GameTexture.fromFile("objects/ironanvil");
   }

   public Rectangle getCollision(Level var1, int var2, int var3, int var4) {
      return var4 % 2 == 0 ? new Rectangle(var2 * 32 + 8, var3 * 32 + 8, 16, 20) : new Rectangle(var2 * 32 + 5, var3 * 32 + 14, 22, 16);
   }
