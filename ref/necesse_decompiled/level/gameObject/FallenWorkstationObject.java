...
public class FallenWorkstationObject extends CraftingStationObject {
   public GameTexture texture;
   protected int counterID;

   private FallenWorkstationObject() {
      super(new Rectangle(32, 32));
      this.mapColor = new Color(155, 73, 57);
   ...
   public static int[] registerFallenWorkstation() {
      FallenWorkstationObject var0 = new FallenWorkstationObject();
      FallenWorkstation2Object var1 = new FallenWorkstation2Object();
      int var2 = ObjectRegistry.registerObject("fallenworkstation", var0, 200.0F, true);
      int var3 = ObjectRegistry.registerObject("fallenworkstation2", var1, 0.0F, false);
      var0.counterID = var3;
      var1.counterID = var2;
