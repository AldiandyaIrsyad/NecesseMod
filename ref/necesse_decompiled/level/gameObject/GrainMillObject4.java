...
class GrainMillObject4 extends GrainMillExtraObject {
   ...
   protected Rectangle getCollision(Level var1, int var2, int var3, int var4) {
      if (var4 == 0) {
         ...
         return var4 == 2 ? new Rectangle(var2 * 32 + 5, var3 * 32 + 12, 27, 20) : new Rectangle(var2 * 32, var3 * 32 + 12, 27, 20);
      }
   }
