...
public class ClockObject extends FurnitureObject {
   protected String textureName;
   public GameTexture texture;

   public ClockObject(String var1, ToolType var2, Color var3) {
   ...
   public ClockObject(String var1, Color var2) {
   ...
   public Rectangle getCollision(Level var1, int var2, int var3, int var4) {
      if (var4 == 0) {
         return new Rectangle(var2 * 32 + 3, var3 * 32 + 16, 24, 16);
      } else if (var4 == 1) {
         return new Rectangle(var2 * 32, var3 * 32 + 3, 16, 24);
      } else {
         return var4 == 2 ? new Rectangle(var2 * 32 + 3, var3 * 32, 24, 16) : new Rectangle(var2 * 32 + 16, var3 * 32 + 3, 16, 24);
      }
   }
   ...
   public void onMouseHover(Level var1, int var2, int var3, GameCamera var4, PlayerMob var5, boolean var6) {
      ...
      if (var5 != null) {
         WorldEntity var7 = var5.getWorldEntity();
         StringTooltips var8 = new StringTooltips();
         var8.add(Localization.translate("ui", "currenttime", "time", var7.getDayTimeReadable()));
         var8.add(var7.getTimeOfDay().displayName.translate());
         Screen.addTooltip(var8, TooltipLocation.INTERACT_FOCUS);
      }
   ...
   public ListGameTooltips getItemTooltips(InventoryItem var1, PlayerMob var2) {
      ...
      if (var2 != null) {
         WorldEntity var4 = var2.getWorldEntity();
         var3.add(Localization.translate("ui", "currenttime", "time", var4.getDayTimeReadable()));
         var3.add(var4.getTimeOfDay().displayName.translate());
      }
