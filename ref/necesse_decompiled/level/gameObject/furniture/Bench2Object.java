...
class Bench2Object extends FurnitureObject {
   protected String textureName;
   public GameTexture texture;
   protected int counterID;

   public Bench2Object(String var1, ToolType var2, Color var3) {
   ...
   public Rectangle getCollision(Level var1, int var2, int var3, int var4) {
      if (var4 == 0) {
         return new Rectangle(var2 * 32 + 4, var3 * 32 + 10, 24, 22);
      } else if (var4 == 1) {
         return new Rectangle(var2 * 32, var3 * 32 + 6, 30, 24);
      } else {
         return var4 == 2 ? new Rectangle(var2 * 32 + 4, var3 * 32, 24, 30) : new Rectangle(var2 * 32 + 2, var3 * 32 + 6, 30, 24);
      }
   }
   ...
   public void addDrawables(List<LevelSortedDrawable> var1, OrderableDrawables var2, Level var3, int var4, int var5, TickManager var6, GameCamera var7, PlayerMob var8) {
      ...
      if (var12 == 0) {
         var13.add(this.texture.initDraw().sprite(2, 1, 32).light(var9).pos(var10, var11 - 32));
         var13.add(this.texture.initDraw().sprite(2, 2, 32).light(var9).pos(var10, var11));
      } else if (var12 == 1) {
         var13.add(this.texture.initDraw().sprite(1, 1, 32, 64).light(var9).pos(var10, var11 - 32));
      } else if (var12 == 2) {
         var13.add(this.texture.initDraw().sprite(3, 3, 32).light(var9).pos(var10, var11));
      } else {
