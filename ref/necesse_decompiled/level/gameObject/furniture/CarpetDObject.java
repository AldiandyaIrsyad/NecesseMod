...
class CarpetDObject extends FurnitureObject {
   ...
   public CarpetDObject(String var1, ToolType var2, Color var3) {
   ...
   public MultiTile getMultiTile(int var1) {
      return new StaticMultiTile(0, 1, 2, 2, true, new int[]{this.counterIDTopLeft, this.counterIDTopRight, this.getID(), this.counterIDBotRight});
   }
   ...
   public void addDrawables(List<LevelSortedDrawable> var1, OrderableDrawables var2, Level var3, int var4, int var5, TickManager var6, GameCamera var7, PlayerMob var8) {
      ...
      TextureDrawOptionsEnd var12 = this.texture.initDraw().sprite(0, 1, 32).light(var9).pos(var10, var11);
      var2.add((var1x) -> {
         var12.draw();
      });
   }
