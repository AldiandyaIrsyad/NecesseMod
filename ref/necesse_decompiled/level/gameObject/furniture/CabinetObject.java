...
public class CabinetObject extends FurnitureObject {
   protected String textureName;
   public GameTexture texture;

   public CabinetObject(String var1, ToolType var2, Color var3) {
   ...
   public CabinetObject(String var1, Color var2) {
   ...
   public Rectangle getCollision(Level var1, int var2, int var3, int var4) {
      if (var4 == 0) {
         return new Rectangle(var2 * 32, var3 * 32 + 20, 32, 12);
      } else if (var4 == 1) {
         return new Rectangle(var2 * 32, var3 * 32, 16, 32);
      } else {
         return var4 == 2 ? new Rectangle(var2 * 32, var3 * 32, 32, 12) : new Rectangle(var2 * 32 + 16, var3 * 32, 16, 32);
      }
   }
   ...
   public ObjectEntity getNewObjectEntity(Level var1, int var2, int var3) {
      return new InventoryObjectEntity(var1, var2, var3, 20);
   }
