...
public class SalvageStationObject extends GameObject {
   ...
   public void loadTextures() {
      super.loadTextures();
      this.texture = GameTexture.fromFile("objects/salvagestation");
   }
   ...
   public void addDrawables(List<LevelSortedDrawable> var1, OrderableDrawables var2, Level var3, int var4, int var5, TickManager var6, GameCamera var7, PlayerMob var8) {
      ...
      final TextureDrawOptionsEnd var12 = this.texture.initDraw().light(var9).pos(var10 + 16 - this.texture.getWidth() / 2, var11 - this.texture.getHeight() + 32);
   ...
   public void drawPreview(Level var1, int var2, int var3, int var4, float var5, PlayerMob var6, GameCamera var7) {
      ...
      this.texture.initDraw().alpha(var5).draw(var8 + 16 - this.texture.getWidth() / 2, var9 - this.texture.getHeight() + 32);
   }
   ...
   public ListGameTooltips getItemTooltips(InventoryItem var1, PlayerMob var2) {
      ...
      var3.add((String)Localization.translate("itemtooltip", "salvagestationtip"), 400);
      return var3;
   }
   ...
   public void interact(Level var1, int var2, int var3, PlayerMob var4) {
      if (var1.isServer()) {
         OEInventoryContainer.openAndSendContainer(ContainerRegistry.SALVAGE_STATION_CONTAINER, var4.getServerClient(), var1, var2, var3);
      }

   }

   public ObjectEntity getNewObjectEntity(Level var1, int var2, int var3) {
      return new SalvageStationObjectEntity(var1, var2, var3);
   }
}
