...
public class SingleRockSmall extends GameObject {
   protected RockObject type;
   protected String textureName;
   public GameTexture texture;
   protected final GameRandom drawRandom;

   public SingleRockSmall(RockObject var1, String var2, Color var3) {
   ...
   public void addDrawables(List<LevelSortedDrawable> var1, OrderableDrawables var2, Level var3, int var4, int var5, TickManager var6, GameCamera var7, PlayerMob var8) {
      ...
      int var12;
      synchronized(this.drawRandom) {
         var12 = this.drawRandom.seeded(this.getTileSeed(var4, var5)).nextInt(this.texture.getWidth() / 32);
      }

      var11 += var13;
      final TextureDrawOptionsEnd var14 = this.texture.initDraw().sprite(var12, 0, 32, this.texture.getHeight()).light(var9).pos(var10, var11 - this.texture.getHeight() + 32);
   ...
   public LootTable getLootTable(Level var1, int var2, int var3) {
      return this.type.droppedStone != null ? new LootTable(new LootItemInterface[]{LootItem.between(this.type.droppedStone, 15, 25).splitItems(5)}) : new LootTable();
   }
