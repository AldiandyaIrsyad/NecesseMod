...
class FireChaliceObject2 extends FireChaliceAbstractObject {
   protected int counterIDTopLeft;
   protected int counterIDBotLeft;
   protected int counterIDBotRight;

   public FireChaliceObject2(String var1, Color var2) {
      super(var1, var2);
   }
   ...
   protected Rectangle getCollision(Level var1, int var2, int var3, int var4) {
      if (var4 == 0) {
         ...
         return var4 == 2 ? new Rectangle(var2 * 32 + 4, var3 * 32, 28, 24) : new Rectangle(var2 * 32 + 4, var3 * 32 + 5, 28, 27);
      }
   }
