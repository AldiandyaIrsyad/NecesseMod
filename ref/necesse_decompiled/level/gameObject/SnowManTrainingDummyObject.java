...
public class SnowManTrainingDummyObject extends GameObject {
   ...
   public SnowManTrainingDummyObject() {
      super(new Rectangle(3, 10, 26, 14));
      this.mapColor = new Color(234, 232, 231);
   ...
   public void loadTextures() {
      super.loadTextures();
      this.base = GameTexture.fromFile("objects/snowmantrainingdummy_base");
      this.body = GameTexture.fromFile("objects/snowmantrainingdummy_body");
   }
   ...
   public void addDrawables(List<LevelSortedDrawable> var1, OrderableDrawables var2, Level var3, int var4, int var5, TickManager var6, GameCamera var7, PlayerMob var8) {
      ...
      final TextureDrawOptionsEnd var14 = this.body.initDraw().sprite(var12, 0, 64).light(var9).pos(var10, var11 - 14);
   ...
   public void drawPreview(Level var1, int var2, int var3, int var4, float var5, PlayerMob var6, GameCamera var7) {
      ...
      this.body.initDraw().sprite(var4, 0, 64).alpha(var5).draw(var8, var9 - 14);
   }
