...
public class CompostBinObject extends GameObject implements SettlementWorkstationObject {
   ...
   public void loadTextures() {
      super.loadTextures();
      this.texture = GameTexture.fromFile("objects/compostbin");
   }
   ...
   public void addDrawables(List<LevelSortedDrawable> var1, OrderableDrawables var2, Level var3, int var4, int var5, TickManager var6, GameCamera var7, PlayerMob var8) {
      ...
      final TextureDrawOptionsEnd var13 = this.texture.initDraw().sprite(var10 % this.texture.getWidth() / 32, 0, 32, this.texture.getHeight()).light(var9).pos(var11, var12 - (this.texture.getHeight() - 32));
   ...
   public ObjectEntity getNewObjectEntity(Level var1, int var2, int var3) {
      return new CompostBinObjectEntity(var1, var2, var3);
   }
   ...
   public ListGameTooltips getItemTooltips(InventoryItem var1, PlayerMob var2) {
      ...
      var3.add(Localization.translate("itemtooltip", "compostbintip"));
      return var3;
   }
}
