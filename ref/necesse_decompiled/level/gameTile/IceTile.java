...
public class IceTile extends TerrainSplatterTile {
   private final GameRandom drawRandom;

   public IceTile() {
      super(false, "ice");
      this.mapColor = new Color(150, 205, 245);
   ...
   public ModifierValue<Float> getFrictionModifier(Mob var1) {
      return var1.isFlying() ? super.getFrictionModifier(var1) : new ModifierValue(BuffModifiers.FRICTION, -0.75F);
   }
