...
public class DeepSwampRockTile extends TerrainSplatterTile {
   public static double growChance = GameMath.getAverageSuccessRuns(1600.0);
   private final GameRandom drawRandom;

   public DeepSwampRockTile() {
      super(false, "deepswamprocktile");
      this.mapColor = new Color(51, 69, 49);
   ...
   public void addSimulateLogic(Level var1, int var2, int var3, long var4, SimulatePriorityList var6, boolean var7) {
      if (var1.isCave) {
         GrassTile.addSimulateGrow(var1, var2, var3, growChance, var4, "deepswampgrass", var6, var7);
      }
   ...
   public void tick(Level var1, int var2, int var3) {
      if (var1.isServer()) {
         if (var1.isCave && var1.getObjectID(var2, var3) == 0 && GameRandom.globalRandom.getChance(growChance)) {
            GameObject var4 = ObjectRegistry.getObject(ObjectRegistry.getObjectID("deepswampgrass"));
