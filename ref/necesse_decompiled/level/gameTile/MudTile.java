...
public class MudTile extends TerrainSplatterTile {
   private final GameRandom drawRandom;

   public MudTile() {
      super(false, "mud");
      this.mapColor = new Color(85, 63, 58);
   ...
   public ModifierValue<Float> getSlowModifier(Mob var1) {
      return var1.isFlying() ? super.getSpeedModifier(var1) : new ModifierValue(BuffModifiers.SLOW, 0.25F);
   }
}
