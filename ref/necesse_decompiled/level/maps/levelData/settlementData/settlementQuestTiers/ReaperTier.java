...
public class ReaperTier extends SimpleSettlementQuestTier {
   ...
   public Quest getTierCompleteQuest(SettlementLevelData var1) {
      return new HaveKilledMobsSettlementQuest("reaper", 1);
   }
   ...
   static {
      tierQuests.add((var0) -> {
         return new DeliverItemsSettlementQuest("deepspiritswab", 1);
      });
      tierQuests.add((var0) -> {
         return new DeliverItemsSettlementQuest("brokenlimb", 1);
      });
      tierCompleteRewards = new LootTable(new LootItemInterface[]{new LootItem("hoverboard"), addedQuestRewards});
      raiderStats = new TicketSystemList();
      raiderStats.addObject(100, new RaiderConstructor("tungstensword", (String)null, "tungstenchestplate", "tungstenboots", 975, 12, 20, 45));
      raiderStats.addObject(50, new RaiderConstructor("tungstenbow", "demonichelmet", "demonicchestplate", "demonicboots", 825, 10, 20, 45));
      raiderStats.addObject(25, new RaiderConstructor("quartzstaff2", "quartzhelmet", "quartzchestplate", "quartzboots", 675, 8, 20, 45));
   }
}
