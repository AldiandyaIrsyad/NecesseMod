...
public class CryoQueenTier extends SimpleSettlementQuestTier {
   ...
   public CryoQueenTier() {
      super("cryoqueen");
   }

   public Quest getTierCompleteQuest(SettlementLevelData var1) {
      return new HaveKilledMobsSettlementQuest("cryoqueen", 1);
   }
   ...
   static {
      tierQuests.add((var0) -> {
         return new DeliverItemsSettlementQuest("feraltail", 1);
      });
      tierQuests.add((var0) -> {
         return new DeliverItemsSettlementQuest("razoricicle", 1);
      });
      tierCompleteRewards = new LootTable(new LootItemInterface[]{new LootItem("bannerstand"), addedQuestRewards});
