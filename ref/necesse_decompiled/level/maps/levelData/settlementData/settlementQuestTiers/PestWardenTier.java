...
public class PestWardenTier extends SimpleSettlementQuestTier {
   ...
   public PestWardenTier() {
      super("pestwarden");
   }

   public Quest getTierCompleteQuest(SettlementLevelData var1) {
      return new HaveKilledMobsSettlementQuest("pestwarden", 1);
   }
   ...
   static {
      tierQuests.add((var0) -> {
         return new DeliverItemsSettlementQuest("slimesample", 1);
      });
      tierQuests.add((var0) -> {
         return new DeliverItemsSettlementQuest("soakedbow", 1);
      });
      tierCompleteRewards = new LootTable(new LootItemInterface[]{new LootItem("portalflask"), addedQuestRewards});
      raiderStats = new TicketSystemList();
      raiderStats.addObject(100, new RaiderConstructor("tungstensword", "tungstenhelmet", "tungstenchestplate", "tungstenboots", 1200, 14, 20, 45));
      raiderStats.addObject(50, new RaiderConstructor("tungstenbow", (String)null, "shadowmantle", "shadowboots", 900, 12, 20, 45));
      raiderStats.addObject(25, new RaiderConstructor("iciclestaff", "shadowhood", "shadowmantle", "shadowboots", 750, 10, 20, 45));
   }
}
