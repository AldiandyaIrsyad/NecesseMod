...
public class PlantCropLevelJob extends PlaceObjectLevelJob {
   public PlantCropLevelJob(int var1, int var2, int var3) {
      super(var1, var2, var3);
   }

   public PlantCropLevelJob(LoadData var1) {
      super(var1);
   }
   ...
   public static <T extends PlantCropLevelJob> JobSequence getJobSequence(EntityJobWorker var0, boolean var1, FoundJob<T> var2) {
      GameObject var3 = ((PlantCropLevelJob)var2.job).getObject();
      ...
      if (var1) {
         int var6 = ((PlantCropLevelJob)var2.job).getSeedItemID();
      ...
      var5.add(((PlantCropLevelJob)var2.job).getActiveJob(var0, var2.priority, var1));
      return var5;
   }
      ...
      return new TileActiveJob(var1, var2, this.tileX, this.tileY) {
         ...
         public boolean isValid(boolean var1) {
            if (!PlantCropLevelJob.this.isRemoved() && PlantCropLevelJob.this.reservable.isAvailable(this.worker.getMobWorker())) {
               if (var1 && var3) {
                  int var2 = PlantCropLevelJob.this.getSeedItemID();
         ...
         public ActiveJobResult perform() {
            if (this.worker.isInWorkAnimation()) {
               ...
               Item var1 = PlantCropLevelJob.this.plant(var3 ? this.worker.getWorkInventory() : null);
               if (var1 != null) {
