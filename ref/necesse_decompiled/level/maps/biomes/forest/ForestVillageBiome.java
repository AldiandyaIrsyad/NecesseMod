...
public class ForestVillageBiome extends ForestBiome {
   public ForestVillageBiome() {
   }
   ...
   private static Level addVillage(Level var0, float var1) {
      GameEvents.triggerEvent(new GenerateIslandFeatureEvent(var0, var1), (var2) -> {
         ...
         VillageSet var4 = (VillageSet)var3.getOneOf((Object[])(VillageSet.spruce, VillageSet.oak));
