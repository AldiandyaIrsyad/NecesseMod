...
public class ForestBiome extends Biome {
   ...
   public Level getNewSurfaceLevel(int var1, int var2, float var3, Server var4, WorldEntity var5) {
      return new ForestSurfaceLevel(var1, var2, var3, var4, var5);
   }
   ...
   public FishingLootTable getFishingLootTable(FishingSpot var1) {
      return !var1.tile.level.isCave ? forestSurfaceFish : super.getFishingLootTable(var1);
   }
   ...
   public LootTable getExtraMobDrops(Mob var1) {
      if (var1.isHostile && !var1.isBoss() && !var1.isSummoned) {
         if (var1.getLevel().getIslandDimension() == -1) {
            return new LootTable(new LootItemInterface[]{randomPortalDrop, super.getExtraMobDrops(var1)});
         }

         if (var1.getLevel().getIslandDimension() == -2) {
            return new LootTable(new LootItemInterface[]{randomShadowGateDrop, super.getExtraMobDrops(var1)});
         }
      }
   ...
   static {
      ...
      forestSurfaceFish = (new FishingLootTable(defaultSurfaceFish)).addWater(120, (String)"furfish");
