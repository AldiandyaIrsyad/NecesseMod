...
public class ForestSurfaceLevel extends Level {
   public ForestSurfaceLevel(LevelIdentifier var1, int var2, int var3, WorldEntity var4) {
      super(var1, var2, var3, var4);
   }

   public ForestSurfaceLevel(int var1, int var2, float var3, Server var4, WorldEntity var5) {
      super(new LevelIdentifier(var1, var2, 0), 300, 300, var5);
   ...
   public void generateLevel(float var1) {
      ...
      GameEvents.triggerEvent(new GenerateIslandFloraEvent(this, var1, var3), (var3x) -> {
         ...
         var3.generateCellMapObjects(0.35F, var4, var6, 0.08F);
         var3.generateCellMapObjects(0.35F, var5, var6, 0.12F);
         var3.generateObjects(var6x, var6, 0.4F);
         ...
         var3.ensureGenerateObjects("beehive", 1, (int[])(var6));
         var3.generateFruitGrowerSingle("appletree", 0.02F, var6);
         var3.generateFruitGrowerVeins("blueberrybush", 0.04F, 8, 10, 0.1F, (int[])(var6));
         GenerationTools.generateRandomObjectVeinsOnTile(this, var3.random, 0.03F, 6, 12, var6, ObjectRegistry.getObjectID("wildfiremone"), 0.2F, false);
      ...
      GameEvents.triggerEvent(new GenerateIslandStructuresEvent(this, var1, var3), (var2x) -> {
         GenerationTools.spawnRandomPreset(this, new RandomRuinsPreset(var3.random), false, false, var3.random, false, 40, 1);
      });
      ...
      GameEvents.triggerEvent(new GenerateIslandAnimalsEvent(this, var1, var3), (var3x) -> {
         var3.spawnMobHerds("sheep", var3.random.getIntBetween(25, 45), var6, 2, 6, var1);
         var3.spawnMobHerds("cow", var3.random.getIntBetween(15, 35), var6, 2, 6, var1);
      });
