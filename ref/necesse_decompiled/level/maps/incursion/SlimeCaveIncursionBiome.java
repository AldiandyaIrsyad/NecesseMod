...
public class SlimeCaveIncursionBiome extends IncursionBiome {
   public SlimeCaveIncursionBiome() {
      super("motherslime");
   }

   public Collection<Item> getExtractionItems(IncursionData var1) {
      return Collections.singleton(ItemRegistry.getItem("slimeum"));
   }

   public LootTable getHuntDrop(IncursionData var1) {
      return new LootTable(new LootItemInterface[]{new ChanceLootItem(0.66F, "slimematter")});
   }

   public LootTable getBossDrop(final IncursionData var1) {
      return new LootTable(new LootItemInterface[]{LootItem.between("slimeessence", 20, 25), new LootItemInterface() {
         public void addPossibleLoot(LootList var1x, Object... var2) {
            InventoryItem var3 = new InventoryItem("gatewaytablet");
            var3.getGndData().setInt("displayTier", SlimeCaveIncursionBiome.this.increaseTabletTierByX(var1.getTabletTier(), 1));
         ...
         public void addItems(List<InventoryItem> var1x, GameRandom var2, float var3, Object... var4) {
            ...
            GatewayTabletItem.initializeGatewayTablet(var5, var2, SlimeCaveIncursionBiome.this.increaseTabletTierByX(var1.getTabletTier(), 1));
            var1x.add(var5);
         }
      }});
   }
   ...
   public IncursionLevel getNewIncursionLevel(LevelIdentifier var1, BiomeMissionIncursionData var2, Server var3, WorldEntity var4) {
      return new SlimeCaveIncursionLevel(var1, var2, var4);
   }

   public ArrayList<Color> getFallenAltarGatewayColorsForBiome() {
      ArrayList var1 = new ArrayList();
      var1.add(new Color(140, 139, 50));
      var1.add(new Color(247, 255, 3));
      var1.add(new Color(145, 150, 13));
      var1.add(new Color(247, 255, 3));
      var1.add(new Color(241, 244, 152));
      var1.add(new Color(253, 250, 236));
      return var1;
   }
}
