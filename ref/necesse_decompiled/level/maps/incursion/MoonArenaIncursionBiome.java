...
public class MoonArenaIncursionBiome extends IncursionBiome {
   ...
   public LootTable getBossDrop(final IncursionData var1) {
      return new LootTable(new LootItemInterface[]{new LootItemInterface() {
         public void addPossibleLoot(LootList var1x, Object... var2) {
            ...
            var3.getGndData().setInt("displayTier", MoonArenaIncursionBiome.this.increaseTabletTierByX(var1.getTabletTier(), 1));
         ...
         public void addItems(List<InventoryItem> var1x, GameRandom var2, float var3, Object... var4) {
            ...
            GatewayTabletItem.initializeGatewayTablet(var5, var2, MoonArenaIncursionBiome.this.increaseTabletTierByX(var1.getTabletTier(), 1));
            var1x.add(var5);
         }
      }});
   }
   ...
   public ArrayList<FairType> getPrivateDropsDisplay(FontOptions var1) {
      ...
      InventoryItem var5 = new InventoryItem("duskhelmet", 1);
      var5.item.setUpgradeTier(var5, 1.0F);
      var4.add(var5);
      InventoryItem var6 = new InventoryItem("duskchestplate", 1);
      var6.item.setUpgradeTier(var6, 1.0F);
      var4.add(var6);
      InventoryItem var7 = new InventoryItem("duskboots", 1);
      var7.item.setUpgradeTier(var7, 1.0F);
      var4.add(var7);
      var3.append(new FairItemGlyph(var1.getSize(), var4));
      var3.append(var1, " " + Localization.translate("incursion", "duskarmorloot", "tier", (int)1));
      var2.add(var3);
      return var2;
   }
   ...
   public IncursionLevel getNewIncursionLevel(LevelIdentifier var1, BiomeMissionIncursionData var2, Server var3, WorldEntity var4) {
      return new MoonArenaIncursionLevel(var1, var2, var4);
   }

   public ArrayList<Color> getFallenAltarGatewayColorsForBiome() {
      ArrayList var1 = new ArrayList();
      var1.add(new Color(156, 155, 239));
      var1.add(new Color(220, 212, 255));
      var1.add(new Color(156, 155, 239));
      var1.add(new Color(184, 174, 255));
      var1.add(new Color(220, 212, 255));
