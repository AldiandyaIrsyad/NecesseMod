...
public class GraveyardIncursionBiome extends IncursionBiome {
   public static ChanceLootItemList graveyardMobDrops = new ChanceLootItemList(0.03F, new LootItemInterface[]{new OneOfLootItems(new LootItem("bloodclaw", (new GNDItemMap()).setInt("upgradeLevel", 100)), new LootItemInterface[]{new LootItem("thecrimsonsky", (new GNDItemMap()).setInt("upgradeLevel", 100)), new LootItem("bloodgrimoire", (new GNDItemMap()).setInt("upgradeLevel", 100)), new LootItem("bloodstonering", (new GNDItemMap()).setInt("upgradeLevel", 100))})});
   ...
   public LootTable getHuntDrop(IncursionData var1) {
      return new LootTable(new LootItemInterface[]{new ChanceLootItem(0.66F, "phantomdust")});
   }

   public LootTable getBossDrop(final IncursionData var1) {
      return new LootTable(new LootItemInterface[]{LootItem.between("bloodessence", 20, 25), new LootItemInterface() {
         public void addPossibleLoot(LootList var1x, Object... var2) {
            InventoryItem var3 = new InventoryItem("gatewaytablet");
            var3.getGndData().setInt("displayTier", GraveyardIncursionBiome.this.increaseTabletTierByX(var1.getTabletTier(), 1));
         ...
         public void addItems(List<InventoryItem> var1x, GameRandom var2, float var3, Object... var4) {
            ...
            GatewayTabletItem.initializeGatewayTablet(var5, var2, GraveyardIncursionBiome.this.increaseTabletTierByX(var1.getTabletTier(), 1));
            var1x.add(var5);
         }
      }});
   }
   ...
   public IncursionLevel getNewIncursionLevel(LevelIdentifier var1, BiomeMissionIncursionData var2, Server var3, WorldEntity var4) {
      return new GraveyardIncursionLevel(var1, var2, var4);
   }

   public ArrayList<Color> getFallenAltarGatewayColorsForBiome() {
      ArrayList var1 = new ArrayList();
      var1.add(new Color(140, 50, 50));
      var1.add(new Color(255, 3, 3));
      var1.add(new Color(150, 13, 13));
      var1.add(new Color(255, 3, 3));
      var1.add(new Color(244, 152, 152));
      var1.add(new Color(253, 236, 236));
      return var1;
   }
}
