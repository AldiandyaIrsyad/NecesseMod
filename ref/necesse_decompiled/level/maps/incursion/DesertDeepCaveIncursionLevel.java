...
public class DesertDeepCaveIncursionLevel extends IncursionLevel {
   public DesertDeepCaveIncursionLevel(LevelIdentifier var1, int var2, int var3, WorldEntity var4) {
      super(var1, var2, var3, var4);
   }

   public DesertDeepCaveIncursionLevel(LevelIdentifier var1, BiomeMissionIncursionData var2, WorldEntity var3) {
      super(var1, 150, 150, var2, var3);
      this.biome = BiomeRegistry.DESERT_DEEP_CAVE_INCURSION;
      this.isCave = true;
      this.generateLevel(var2);
   }

   public void generateLevel(BiomeMissionIncursionData var1) {
      CaveGeneration var2 = new CaveGeneration(this, "deepsandstonetile", "deepsandstonerock");
      ...
      GameEvents.triggerEvent(new GenerateCaveMiniBiomesEvent(this, var2), (var2x) -> {
         ...
         var2.generateRandomSingleRocks(ObjectRegistry.getObjectID("deepsandcaverock"), 0.005F);
         var2.generateRandomSingleRocks(ObjectRegistry.getObjectID("deepsandcaverocksmall"), 0.01F);
      });
      ...
      IncursionBiome.generateEntrance(this, var2.random, 30, var2.rockTile, "sandbrick", "woodfloor", "deepsandstonecolumn");
      GenerationTools.checkValid(this);
      if (var1 instanceof BiomeExtractionIncursionData) {
         var2.generateGuaranteedOreVeins(100, 8, 16, ObjectRegistry.getObjectID("ancientfossiloredeepsnowrock"));
      }

      var2.generateGuaranteedOreVeins(100, 6, 12, ObjectRegistry.getObjectID("upgradesharddeepsandstonerock"));
      var2.generateGuaranteedOreVeins(100, 6, 12, ObjectRegistry.getObjectID("alchemysharddeepsandstonerock"));
