...
public abstract class ShortLevelLayer extends LevelLayer {
   protected short[] data;

   public ShortLevelLayer(Level var1) {
      super(var1);
      this.data = new short[var1.width * var1.height];
   ...
   public void writeRegionPacket(Region var1, PacketWriter var2) {
      for(int var3 = 0; var3 < var1.regionWidth; ++var3) {
         ...
         for(int var5 = 0; var5 < var1.regionHeight; ++var5) {
            ...
            var2.putNextShort(this.get(var4, var6));
         }
      }
   ...
   protected abstract boolean isValidRegionValue(int var1, int var2, short var3);

   public void addSaveData(SaveData var1) {
      var1.addShortArray(this.getSaveDataName(), this.data);
   }
   ...
   public void loadSaveData(LoadData var1) {
      try {
         ...
         short[] var3 = LoadData.getShortArray(var2);
   ...
   protected void handleLoadException(Exception var1) {
      ...
      this.data = new short[this.level.width * this.level.height];
      if (this.getDefault() != 0) {
         Arrays.fill(this.data, this.getDefault());
      }
