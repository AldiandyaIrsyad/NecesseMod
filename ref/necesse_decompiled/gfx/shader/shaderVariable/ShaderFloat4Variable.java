...
public class ShaderFloat4Variable extends ShaderVariable<Float[]> {
   public ShaderFloat4Variable(String var1) {
      super(var1);
   }

   public void addInputs(GameShader var1, ComponentListContainer<? super FormComponent> var2, int var3, FormFlow var4, int var5) {
      float[] var6 = var1.get4f(this.varName);
      ...
      this.addTextInput(var1, var2, var3, var4, var5, var6, 3);
   }
   ...
   protected void apply(GameShader var1, float[] var2) {
      var1.use();
      var1.pass4f(this.varName, var2[0], var2[1], var2[2], var2[3]);
      var1.stop();
   }
}
