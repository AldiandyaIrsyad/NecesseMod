...
public class ShaderInt3Variable extends ShaderVariable<Integer[]> {
   public ShaderInt3Variable(String var1) {
      super(var1);
   }

   public void addInputs(GameShader var1, ComponentListContainer<? super FormComponent> var2, int var3, FormFlow var4, int var5) {
      int[] var6 = var1.get3i(this.varName);
   ...
   protected void apply(GameShader var1, int[] var2) {
      var1.use();
      var1.pass3i(this.varName, var2[0], var2[1], var2[2]);
      var1.stop();
   }
}
