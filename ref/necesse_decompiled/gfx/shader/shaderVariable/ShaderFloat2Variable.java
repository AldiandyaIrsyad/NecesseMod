...
public class ShaderFloat2Variable extends ShaderVariable<Float[]> {
   public ShaderFloat2Variable(String var1) {
      super(var1);
   }

   public void addInputs(GameShader var1, ComponentListContainer<? super FormComponent> var2, int var3, FormFlow var4, int var5) {
      float[] var6 = var1.get2f(this.varName);
   ...
   protected void apply(GameShader var1, float[] var2) {
      var1.use();
      var1.pass2f(this.varName, var2[0], var2[1]);
      var1.stop();
   }
}
