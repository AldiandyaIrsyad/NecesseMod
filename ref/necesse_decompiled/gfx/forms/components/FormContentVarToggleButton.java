...
public abstract class FormContentVarToggleButton extends FormButton implements FormPositionContainer {
   private FormPosition position;
   private int width;
   private Supplier<Boolean> isToggled;
   public FormInputSize size;
   public ButtonColor color;
   public boolean useDownTexture = true;

   public FormContentVarToggleButton(int var1, int var2, int var3, FormInputSize var4, ButtonColor var5, Supplier<Boolean> var6) {
   ...
   public boolean isButtonDown() {
      return this.useDownTexture && (Boolean)this.isToggled.get() || this.isDown() && this.isHovering();
   }

   public boolean isToggled() {
      return (Boolean)this.isToggled.get();
   }
}
