...
public abstract class FormTeamInvite extends Form {
   public Color backgroundColor;

   public FormTeamInvite(int var1, int var2, int var3, int var4, PvPTeamsContainer.InviteData var5, Color var6) {
      super(var3, var4);
      ...
      this.addComponent(new FormLabel(var5.teamName, new FontOptions(16), -1, 44, var4 / 2 - 8, var3 - 44 - 4));
   }
