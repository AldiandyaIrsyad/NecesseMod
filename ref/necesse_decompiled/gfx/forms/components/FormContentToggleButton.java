...
public abstract class FormContentToggleButton extends FormButtonToggle implements FormPositionContainer {
   ...
   public FormContentToggleButton(int var1, int var2, int var3, FormInputSize var4, ButtonColor var5) {
   ...
   public void draw(TickManager var1, PlayerMob var2, Rectangle var3) {
      ...
      Rectangle var9 = this.shouldLimitDrawArea ? new Rectangle(var8) : new Rectangle(-this.getX(), -this.getY(), Screen.getHudWidth(), Screen.getHudHeight());
      FormShader.FormShaderState var10 = GameResources.formShader.startState(new Point(this.getX(), this.getY()), var9);
      ...
      this.drawTopContent(this.getX(), this.getY(), var8.width, var8.height);
      if (this.isHovering()) {
   ...
   public ButtonState getButtonState() {
      if (this.isActive() && !this.isOnCooldown()) {
         return !this.isHovering() && (this.useDownTexture || !this.isToggled()) ? ButtonState.ACTIVE : ButtonState.HIGHLIGHTED;
      } else {
