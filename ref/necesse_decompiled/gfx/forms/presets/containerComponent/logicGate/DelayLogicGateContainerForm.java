...
public class DelayLogicGateContainerForm<T extends DelayLogicGateContainer> extends LogicGateContainerForm<T> {
   private final GameEventListener<LogicGateEntity.ApplyPacketEvent> applyListener;

   public DelayLogicGateContainerForm(Client var1, final T var2) {
