...
public class TimerLogicGateContainerForm<T extends TimerLogicGateContainer> extends LogicGateContainerForm<T> {
   private final GameEventListener<LogicGateEntity.ApplyPacketEvent> applyListener;

   public TimerLogicGateContainerForm(Client var1, final T var2) {
      ...
      final FormSlider var3 = ((FormSlider)this.addComponent(new FormSlider("", 280, 65, var2.entity.timerTicks, 10, 200, 100))).onGrab((var1x) -> {
         if (!var1x.grabbed) {
            var2.setTicks.runAndSend(((FormSlider)var1x.from).getValue());
         }
      ...
      this.addComponent(new FormLocalLabel(new LocalMessage("ui", "timertip", new Object[]{"ticks", 20}), new FontOptions(12), -1, 280, var3.getY() + var3.getTotalHeight() + 5, 100));
      this.applyListener = (GameEventListener)var2.entity.applyPacketEvents.addListener(new GameEventListener<LogicGateEntity.ApplyPacketEvent>() {
         public void onEvent(LogicGateEntity.ApplyPacketEvent var1) {
            var3.setValue(var2.entity.timerTicks);
         }
